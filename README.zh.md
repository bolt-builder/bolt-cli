...
OpenCode 也提供桌面版应用。可直接从 [发布页 (releases page)](https://github.com/Bolt-builder/bolt-cli/actions/workflows/publish.ym/releases) 或 [opencode.ai/download](https://opencode.ai/download) 下载。
