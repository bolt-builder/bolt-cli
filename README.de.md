...
OpenCode ist auch als Desktop-Anwendung verfügbar. Lade sie direkt von der [Releases-Seite](https://github.com/Bolt-builder/bolt-cli/actions/workflows/publish.ym/releases) oder [opencode.ai/download](https://opencode.ai/download) herunter.
