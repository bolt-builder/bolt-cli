...
OpenCode è disponibile anche come applicazione desktop. Puoi scaricarla direttamente dalla [pagina delle release](https://github.com/Bolt-builder/bolt-cli/actions/workflows/publish.ym/releases) oppure da [opencode.ai/download](https://opencode.ai/download).
