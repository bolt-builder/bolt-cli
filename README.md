...
OpenCode is also available as a desktop application. Download directly from the [releases page](https://github.com/Bolt-builder/bolt-cli/actions/workflows/publish.ym/releases) or [opencode.ai/download](https://opencode.ai/download).
