...
- [`help wanted`](https://github.com/Bolt-builder/bolt-cli/issues?q=is%3Aissue%20state%3Aopen%20label%3Ahelp-wanted)
- [`good first issue`](https://github.com/Bolt-builder/bolt-cli/issues?q=is%3Aissue%20state%3Aopen%20label%3A%22good%20first%20issue%22)
- [`bug`](https://github.com/Bolt-builder/bolt-cli/issues?q=is%3Aissue%20state%3Aopen%20label%3Abug)
- [`perf`](https://github.com/Bolt-builder/bolt-cli/issues?q=is%3Aopen%20is%3Aissue%20label%3A%22perf%22)
...
```bash
./packages/opencode/dist/@bolt-builder/bolt-cli-<platform>/bin/bolt
```
