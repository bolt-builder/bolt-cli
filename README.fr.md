...
OpenCode est aussi disponible en application de bureau. Téléchargez-la directement depuis la [page des releases](https://github.com/Bolt-builder/bolt-cli/actions/workflows/publish.ym/releases) ou [opencode.ai/download](https://opencode.ai/download).
