...
OpenCode también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/Bolt-builder/bolt-cli/actions/workflows/publish.ym/releases) o desde [opencode.ai/download](https://opencode.ai/download).
