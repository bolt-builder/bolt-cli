   ...
   jobs:
     opencode:
       ...
       steps:
          ...
          - name: Run opencode
           uses: bolt-builder/bolt-cli/github@latest
           env:
...
This is an early release. If you encounter issues or have feedback, please create an issue at https://github.com/Bolt-builder/bolt-cli/issues.
