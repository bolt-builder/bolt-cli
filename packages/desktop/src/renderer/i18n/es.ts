export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Bolt",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Bolt. ¿Quieres instalarla y reiniciar?",
