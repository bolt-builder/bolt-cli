export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Bolt",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل الإصدار {{version}} من Bolt. هل ترغب في تثبيته وإعادة تشغيل التطبيق؟",
