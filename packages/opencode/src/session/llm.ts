...
import { llmClient } from "@bolt-ai/core/effect/app-node-platform"
...
import type { LLMEvent } from "@bolt-ai/llm"
import { LLMClient } from "@bolt-ai/llm/route"
import type { LLMClientService } from "@bolt-ai/llm/route"
...
import { EventV2 } from "@bolt-ai/core/event"
...
export class Service extends Context.Service<Service, Interface>()("@bolt/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @bolt-ai/llm. It
