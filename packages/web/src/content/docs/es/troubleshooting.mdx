...
OpenCode Desktop ejecuta un servidor Bolt local (el sidecar `opencode-cli`) en segundo plano. La mayoría de los problemas se deben a un complemento que no funciona correctamente, una memoria caché dañada o una mala configuración del servidor.
...
1. **Informar problemas el GitHub**
   ...
   [**https://github.com/Bolt-builder/bolt-cli/issues**](https://github.com/Bolt-builder/bolt-cli/actions/workflows/publish.ym/issues)
