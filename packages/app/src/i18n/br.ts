export const dict = {
  ...
  "settings.gateways.description":
    "Conecte um gateway de IA para acessar vários modelos com uma única chave de API, incluindo modelos gratuitos.",
  ...
  "settings.gateways.note.zoo": "Gateway da comunidade do projeto Zoo Code",
