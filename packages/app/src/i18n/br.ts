export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Bolt",
  ...
  "desktop.menu.ariaLabel": "Menu do Bolt",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Bolt",
  "desktop.recovery.terminated": "A janela do Bolt foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Bolt não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do Bolt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O Bolt não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Bolt foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Bolt.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Bolt.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Bolt.",
  ...
  "dialog.server.description": "Trocar para qual servidor Bolt este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Bolt em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Bolt...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Bolt em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Bolt em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Bolt",
  "wsl.onboarding.opencodeReadyIn": "O Bolt está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Bolt está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Bolt em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Bolt",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Bolt não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Bolt possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Bolt não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Bolt novamente.",
  ...
  "help.tabs.introduction": "Agora, o Bolt Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Bolt ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Bolt",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Bolt ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Bolt inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Bolt dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Bolt",
  ...
  "settings.general.row.appearance.description": "Personalize como o Bolt aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Bolt segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Bolt é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Bolt iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Bolt.",
  ...
  "settings.gateways.description": "Conecte um gateway de IA para acessar muitos modelos com uma única chave de API, incluindo modelos gratuitos.",
  "settings.gateways.tag.connected": "Conectado",
  "settings.gateways.note.kilo": "Gateway compatível com OpenRouter com modelos gratuitos roteados automaticamente",
  "settings.gateways.note.zoo": "Gateway comunitário do projeto Zoo Code",
  "settings.gateways.connect.title": "Conectar {{gateway}}",
  "settings.gateways.connect.description": "Cole sua chave de API do {{gateway}} para conectar seus modelos.",
