export const dict = {
  ...
  "settings.gateways.description":
    "برای دسترسی به مدل‌های زیاد با یک کلید API، از جمله مدل‌های رایگان، یک دروازه هوش مصنوعی وصل کنید.",
  ...
  "settings.gateways.connect.description": "برای اتصال مدل‌های آن، کلید API {{gateway}} خود را بچسبانید.",
