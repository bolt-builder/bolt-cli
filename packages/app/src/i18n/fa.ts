export const dict = {
  ...
  "settings.gateways.description":
    "برای دسترسی به مدل‌های بسیار، از جمله مدل‌های رایگان، با یک کلید API، یک دروازه هوش مصنوعی وصل کنید.",
  ...
  "settings.gateways.connect.title": "{{gateway}} را وصل کنید",
  "settings.gateways.connect.description": "کلید API {{gateway}} خود را جای‌گذاری کنید تا مدل‌های آن وصل شوند.",
