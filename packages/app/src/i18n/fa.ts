export const dict = {
  ...
  "settings.gateways.title": "دروازه‌ها",
  "settings.gateways.description": "برای دسترسی به مدل‌های فراوان با یک کلید API، از جمله مدل‌های رایگان، یک دروازه هوش مصنوعی متصل کنید.",
  "settings.gateways.tag.connected": "متصل",
  "settings.gateways.note.kilo": "دروازه سازگار با OpenRouter با مدل‌های رایگان با مسیریابی خودکار",
  "settings.gateways.note.zoo": "دروازه اجتماعی از پروژه Zoo Code",
  "settings.gateways.connect.title": "اتصال {{gateway}}",
  "settings.gateways.connect.description": "کلید API {{gateway}} خود را جای‌گذاری کنید تا مدل‌های آن متصل شوند.",
