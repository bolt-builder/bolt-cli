export const dict = {
  ...
  "settings.gateways.title": "درگاه‌ها",
  "settings.gateways.description":
    "یک درگاه هوش مصنوعی را متصل کنید تا با یک کلید API به مدل‌های زیادی، از جمله مدل‌های رایگان، دسترسی داشته باشید.",
  "settings.gateways.tag.connected": "متصل",
  "settings.gateways.note.kilo": "درگاه سازگار با OpenRouter با مدل‌های رایگان با مسیریابی خودکار",
  "settings.gateways.note.zoo": "درگاه انجمنی از پروژه Zoo Code",
