export const dict = {
  ...
  "settings.gateways.description": "Connecteu una passarel·la d'IA per accedir a molts models amb una sola clau API, incloent-hi models gratuïts.",
  "settings.gateways.tag.connected": "Connectada",
  ...
  "settings.gateways.connect.description": "Enganxeu la vostra clau API de {{gateway}} per connectar els seus models.",
