export const dict = {
  ...
  "settings.gateways.description":
    "Connecta una passarel·la d'IA per accedir a molts models amb una sola clau API, inclosos models gratuïts.",
  ...
  "settings.gateways.connect.description": "Enganxa la teva clau API de {{gateway}} per connectar els seus models.",
