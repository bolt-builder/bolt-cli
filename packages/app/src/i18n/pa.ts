export const dict = {
  ...
  "settings.gateways.description": "اک ای API کلید نال کئی ماڈلز، مفت ماڈلز سمیت، تک رسائی لئی AI گیٹ وے جوڑو۔",
  "settings.gateways.tag.connected": "جڑیا ہویا",
  "settings.gateways.note.kilo": "مفت آٹو روٹڈ ماڈلز والا OpenRouter نال مطابقت رکھن والا گیٹ وے",
  "settings.gateways.note.zoo": "Zoo Code پراجیکٹ ولوں کمیونٹی گیٹ وے",
  "settings.gateways.connect.title": "{{gateway}} نال جڑو",
  "settings.gateways.connect.description": "ایہدے ماڈلز جوڑن لئی اپنی {{gateway}} API کلید پیسٹ کرو۔",
