export const dict = {
  ...
  "desktop.menu.documentation": "Bolt دیاں دستاویزاں",
  ...
  "desktop.menu.ariaLabel": "Bolt مینو",
  ...
  "desktop.recovery.loadFailed": "Bolt لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "Bolt دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "Bolt جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installOpencode": "Bolt دی تنصیب ناکام ہو گئی",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} وچ Bolt انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "Bolt دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے Bolt وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے Bolt وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے Bolt وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.server.description": "ایہہ ایپ کس Bolt سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingOpencode": "Bolt چیک کر رئے آں...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} چ Bolt دی جانچ پڑتال...",
  "wsl.onboarding.updatingOpencode": "Bolt نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} وچ Bolt نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} وچ Bolt نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateOpencode": "Bolt اپ ڈیٹ کرو",
  "wsl.onboarding.opencodeReadyIn": "Bolt {{distro}} چ تیار اے۔",
  "wsl.onboarding.opencodeReady": "Bolt تیار اے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} وچ Bolt انسٹال کرو۔",
  "wsl.onboarding.installOpencode": "Bolt انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Bolt انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Bolt دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "Bolt ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر Bolt دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "Bolt Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Bolt ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع Bolt ٹیم نوں دیو",
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Bolt ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "Bolt چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "app.name.desktop": "Bolt ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر Bolt سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "Bolt لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے Bolt کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا Bolt سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Bolt نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں Bolt لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی Bolt دا تازہ ترین ورژن چلا رئے او۔",
  ...
  "settings.gateways.title": "گیٹ ویز",
  "settings.gateways.description": "اک AI گیٹ وے جوڑو تاں جو اک ای API کنجی نال کئی ماڈلاں تک رسائی ہووے، مفت ماڈلاں سمیت۔",
  "settings.gateways.tag.connected": "جڑیا ہویا",
  "settings.gateways.note.kilo": "مفت آپے روٹ ہون والے ماڈلاں نال OpenRouter دے نال رلدا گیٹ وے",
  "settings.gateways.note.zoo": "Zoo Code پروجیکٹ ولوں کمیونٹی گیٹ وے",
  "settings.gateways.connect.title": "{{gateway}} نال جڑو",
  "settings.gateways.connect.description": "ایہدے ماڈلاں نال جڑن لئی اپنی {{gateway}} API کنجی چسپاں کرو۔",
