export const dict: Record<string, string> = {
  ...
  "settings.gateways.description":
    "API ལྡེ་མིག་གཅིག་གི་ཐོག་ལས་ རིན་མེད་དཔེ་གཞི་ཚུ་བརྩིས་ཏེ་ དཔེ་གཞི་ལེ་ཤ་ལག་ལེན་འཐབ་ནིའི་དོན་ལུ་ AI གེཊ་ཝེ་ཅིག་མཐུད།",
  "settings.gateways.tag.connected": "མཐུད་དེ་ཡོད",
  "settings.gateways.note.kilo": "རིན་མེད་རང་བཞིན་འགྲུལ་ལམ་དཔེ་གཞི་ཚུ་དང་བཅས་ OpenRouter དང་མཐུན་པའི་གེཊ་ཝེ",
  "settings.gateways.note.zoo": "Zoo Code ལས་འགུལ་གྱི་མི་སྡེ་གེཊ་ཝེ",
  "settings.gateways.connect.title": "{{gateway}} མཐུད",
  "settings.gateways.connect.description": "དེའི་དཔེ་གཞི་ཚུ་མཐུད་ནིའི་དོན་ལུ་ ཁྱོད་ཀྱི་ {{gateway}} API ལྡེ་མིག་སྦྱར།",
