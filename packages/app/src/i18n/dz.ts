export const dict: Record<string, string> = {
  ...
  "settings.gateways.description":
    "API ལྡེ་མིག་གཅིག་གིས་ རིན་མེད་དཔེ་ཚད་ཚུ་བརྩིས་ཏེ་ དཔེ་ཚད་མང་རབས་ཅིག་ལུ་འཛུལ་སྤྱོད་འབད་ནིའི་དོན་ལུ་ AI གེཊ་ཝེ་ཅིག་མཐུད།",
  "settings.gateways.tag.connected": "མཐུད་ཡོད།",
  "settings.gateways.note.kilo": "རིན་མེད་རང་བཞིན་ལམ་སྟོན་དཔེ་ཚད་ཚུ་དང་བཅས་ OpenRouter-མཐུན་འགྱུར་གེཊ་ཝེ།",
  "settings.gateways.note.zoo": "Zoo Code ལས་འགུལ་གྱི་སྤྱི་ཚོགས་གེཊ་ཝེ།",
  "settings.gateways.connect.title": "{{gateway}}མཐུད།",
  "settings.gateways.connect.description": "དཔེ་ཚད་ཚུ་མཐུད་ནིའི་དོན་ལུ་ ཁྱོད་ཀྱི་ {{gateway}} API ལྡེ་མིག་སྦྱར།",
