export const dict: Record<string, string> = {
  ...
  "settings.gateways.title": "འགྲུལ་སྒོ་ཚུ",
  "settings.gateways.description": "API ལྡེ་མིག་གཅིག་གི་ཐོག་ལས་དཔེ་གཞི་མང་རབས་ལུ་འཛུལ་སྤྱོད་འབད་ནིའི་དོན་ལུ་ AI འགྲུལ་སྒོ་ཅིག་མཐུད་གནང་། རིན་མེད་དཔེ་གཞི་ཚུ་ཡང་གྲངས་སུ་ཚུད།",
  "settings.gateways.tag.connected": "མཐུད་ཡོདཔ",
  "settings.gateways.note.kilo": "རིན་མེད་རང་བཞིན་འགྲུལ་ལམ་དཔེ་གཞི་ཚུ་དང་བཅས་ OpenRouter དང་མཐུན་པའི་འགྲུལ་སྒོ",
  "settings.gateways.note.zoo": "Zoo Code ལས་འགུལ་ལས་བྱུང་བའི་མི་སྡེའི་འགྲུལ་སྒོ",
  "settings.gateways.connect.title": "{{gateway}} མཐུད་གནང་",
  "settings.gateways.connect.description": "དེའི་དཔེ་གཞི་ཚུ་མཐུད་ནིའི་དོན་ལུ་ ཁྱོད་ཀྱི་ {{gateway}} API ལྡེ་མིག་སྦྱར་གནང་།",
