...
export const dict = {
  ...
  "settings.gateways.description":
    "Tengdu gervigreindargátt til að fá aðgang að mörgum líkönum með einum API-lykli, þar á meðal ókeypis líkönum.",
  ...
  "settings.gateways.connect.description": "Límdu {{gateway}} API-lykilinn þinn til að tengja líkön þess.",
