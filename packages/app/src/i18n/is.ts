...
export const dict = {
  ...
  "settings.gateways.description":
    "Tengdu AI-gátt til að fá aðgang að mörgum fyrirmyndum með einum API-lykli, þar á meðal ókeypis fyrirmyndum.",
  "settings.gateways.tag.connected": "Tengt",
  "settings.gateways.note.kilo": "Gátt samhæfð OpenRouter með ókeypis sjálfvirkt beindum fyrirmyndum",
  "settings.gateways.note.zoo": "Samfélagsgátt frá Zoo Code verkefninu",
  "settings.gateways.connect.title": "Tengja {{gateway}}",
  "settings.gateways.connect.description": "Límdu {{gateway}} API-lykilinn þinn til að tengja fyrirmyndir hennar.",
