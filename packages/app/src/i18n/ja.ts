export const dict = {
  ...
  "settings.gateways.description":
    "AIゲートウェイを接続すると、1つのAPIキーで無料モデルを含む多くのモデルにアクセスできます。",
  "settings.gateways.tag.connected": "接続済み",
  "settings.gateways.note.kilo": "無料の自動ルーティングモデルを備えたOpenRouter互換ゲートウェイ",
  "settings.gateways.note.zoo": "Zoo Codeプロジェクトのコミュニティゲートウェイ",
  "settings.gateways.connect.title": "{{gateway}}を接続",
  "settings.gateways.connect.description": "{{gateway}}のAPIキーを貼り付けて、そのモデルを接続します。",
