export const dict = {
  ...
  "desktop.recovery.loadFailed": "Boltを読み込めませんでした",
  "desktop.recovery.terminated": "Boltのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Boltが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "Boltのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはBoltがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Boltのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Boltで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してBoltで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Boltで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するBoltサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Boltを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のBoltを確認中...",
  "wsl.onboarding.updatingOpencode": "Boltを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のBoltを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のBoltを更新してください。",
  "wsl.onboarding.updateOpencode": "Boltを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のBoltの準備ができました。",
  "wsl.onboarding.opencodeReady": "Boltの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にBoltをインストールしてください。",
  "wsl.onboarding.installOpencode": "Boltをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Boltがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "BoltでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Boltをもう一度開いてください。",
  ...
  "help.tabs.introduction": "Bolt Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Boltの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをBoltチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: BoltはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Boltには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でBoltサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Boltの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのBoltの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Boltがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Boltのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Bolt の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Bolt は最新バージョンです。",
  ...
  "settings.gateways.title": "ゲートウェイ",
  "settings.gateways.description": "AI ゲートウェイを接続すると、無料モデルを含む多くのモデルに 1 つの API キーでアクセスできます。",
  "settings.gateways.tag.connected": "接続済み",
  "settings.gateways.note.kilo": "無料の自動ルーティングモデルを備えた OpenRouter 互換ゲートウェイ",
  "settings.gateways.note.zoo": "Zoo Code プロジェクトによるコミュニティゲートウェイ",
  "settings.gateways.connect.title": "{{gateway}}を接続",
  "settings.gateways.connect.description": "{{gateway}} の API キーを貼り付けて、そのモデルを接続します。",
