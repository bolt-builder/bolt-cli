export const dict = {
  ...
  "settings.gateways.description":
    "Poveži AI gateway za pristup mnogim modelima putem jednog API ključa, uključujući besplatne modele.",
  ...
  "settings.gateways.connect.description": "Zalijepi svoj {{gateway}} API ključ da povežeš njegove modele.",
