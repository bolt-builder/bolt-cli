export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Bolt",
  ...
  "desktop.menu.ariaLabel": "Bolt meni",
  ...
  "desktop.recovery.loadFailed": "Bolt se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Bolt-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Bolt ne reaguje",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Bolt-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Bolt-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Bolt-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Bolt server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Bolt u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Bolt...",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Bolt mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Bolt nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Bolt.",
  ...
  "help.tabs.introduction": "Bolt Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Bolt-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Bolt timu",
  ...
  "sidebar.gettingStarted.line1": "Bolt uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Bolt server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Bolt-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Bolt izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Bolt prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Bolt-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Bolt pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Bolt-a.",
  ...
  "settings.gateways.title": "Gatewayi",
  "settings.gateways.description": "Poveži AI gateway za pristup mnogim modelima putem jednog API ključa, uključujući besplatne modele.",
  "settings.gateways.tag.connected": "Povezano",
  "settings.gateways.note.kilo": "Gateway kompatibilan s OpenRouterom s besplatnim automatski usmjerenim modelima",
  "settings.gateways.note.zoo": "Gateway zajednice iz projekta Zoo Code",
  "settings.gateways.connect.title": "Poveži {{gateway}}",
  "settings.gateways.connect.description": "Zalijepi svoj {{gateway}} API ključ za povezivanje njegovih modela.",
