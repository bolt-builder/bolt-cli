export const dict = {
  ...
  "settings.gateways.description":
    "Povežite AI gateway za pristup mnogim modelima putem jednog API ključa, uključujući besplatne modele.",
  ...
  "settings.gateways.connect.description": "Zalijepite svoj {{gateway}} API ključ da povežete njegove modele.",
