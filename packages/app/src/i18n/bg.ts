export const dict = {
  ...
  "settings.gateways.description":
    "Свържете AI шлюз, за да получите достъп до много модели чрез един API ключ, включително безплатни модели.",
  "settings.gateways.tag.connected": "Свързан",
  "settings.gateways.note.kilo": "Съвместим с OpenRouter шлюз с безплатни автоматично маршрутизирани модели",
  "settings.gateways.note.zoo": "Шлюз на общността от проекта Zoo Code",
  "settings.gateways.connect.title": "Свързване на {{gateway}}",
  "settings.gateways.connect.description": "Поставете своя API ключ за {{gateway}}, за да свържете неговите модели.",
