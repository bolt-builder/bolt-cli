export const dict = {
  ...
  "settings.gateways.title": "Шлюзове",
  "settings.gateways.description": "Свържете AI шлюз, за да получите достъп до много модели чрез един API ключ, включително безплатни модели.",
  "settings.gateways.tag.connected": "Свързан",
  "settings.gateways.note.kilo": "Съвместим с OpenRouter шлюз с безплатни автоматично насочвани модели",
  "settings.gateways.note.zoo": "Общностен шлюз от проекта Zoo Code",
  "settings.gateways.connect.title": "Свързване на {{gateway}}",
  "settings.gateways.connect.description": "Поставете вашия API ключ за {{gateway}}, за да свържете неговите модели.",
