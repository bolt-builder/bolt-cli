export const dict = {
  ...
  "settings.gateways.description":
    "Барои дастрасӣ ба моделҳои зиёд, аз ҷумла моделҳои ройгон, тавассути як калиди API дарвозаи AI-ро пайваст кунед.",
  "settings.gateways.tag.connected": "Пайваст",
  "settings.gateways.note.kilo": "Дарвозаи бо OpenRouter мувофиқ бо моделҳои ройгони худкор равонашаванда",
  "settings.gateways.note.zoo": "Дарвозаи ҷомеа аз лоиҳаи Zoo Code",
  "settings.gateways.connect.title": "Пайвастшавӣ {{gateway}}",
