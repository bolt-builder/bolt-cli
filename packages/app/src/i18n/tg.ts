export const dict = {
  ...
  "settings.gateways.title": "Дарвозаҳо",
  "settings.gateways.description": "Барои дастрасӣ ба моделҳои зиёд бо як калиди API дарвозаи AI-ро пайваст кунед, аз ҷумла моделҳои ройгон.",
  "settings.gateways.tag.connected": "Пайваст шудааст",
  "settings.gateways.note.kilo": "Дарвозаи мувофиқ бо OpenRouter бо моделҳои ройгони худкор равонашаванда",
  "settings.gateways.note.zoo": "Дарвозаи ҷамъиятӣ аз лоиҳаи Zoo Code",
  "settings.gateways.connect.title": "Пайваст кардани {{gateway}}",
  "settings.gateways.connect.description": "Барои пайваст кардани моделҳои он калиди API {{gateway}}-и худро гузоред.",
