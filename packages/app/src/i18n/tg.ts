export const dict = {
  ...
  "settings.gateways.description":
    "Дарвозаи AI-ро пайваст кунед, то бо як калиди API ба бисёр моделҳо, аз ҷумла моделҳои ройгон, дастрасӣ пайдо кунед.",
  "settings.gateways.tag.connected": "Пайваст шудааст",
  "settings.gateways.note.kilo": "Дарвозаи бо OpenRouter мувофиқ бо моделҳои ройгони худкор масиршаванда",
  "settings.gateways.note.zoo": "Дарвозаи ҷомеа аз лоиҳаи Zoo Code",
  "settings.gateways.connect.title": "Пайваст кардани {{gateway}}",
  "settings.gateways.connect.description": "Калиди API {{gateway}}-и худро гузоред, то моделҳои онро пайваст кунед.",
