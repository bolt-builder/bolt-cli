export const dict = {
  ...
  "settings.gateways.title": "Шлюзҳо",
  "settings.gateways.description":
    "Шлюзи AI-ро пайваст кунед, то тавассути як калиди API ба моделҳои зиёд, аз ҷумла моделҳои ройгон, дастрасӣ пайдо кунед.",
  "settings.gateways.tag.connected": "Пайваст",
  "settings.gateways.note.kilo": "Шлюзи бо OpenRouter мувофиқ бо моделҳои ройгони худкор масиршаванда",
  "settings.gateways.note.zoo": "Шлюзи ҷомеа аз лоиҳаи Zoo Code",
