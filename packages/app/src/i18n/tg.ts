export const dict = {
  ...
  "settings.gateways.description":
    "Барои дастрасӣ ба бисёр моделҳо бо як калиди API, аз ҷумла моделҳои ройгон, шлюзи AI-ро пайваст кунед.",
  "settings.gateways.tag.connected": "Пайваст",
  "settings.gateways.note.kilo": "Шлюзи мувофиқ бо OpenRouter бо моделҳои ройгони худкор равонашаванда",
  "settings.gateways.note.zoo": "Шлюзи ҷомеа аз лоиҳаи Zoo Code",
  "settings.gateways.connect.title": "Пайвастшавӣ {{gateway}}",
  "settings.gateways.connect.description": "Калиди API {{gateway}}-и худро часбонед, то моделҳои онро пайваст кунед.",
