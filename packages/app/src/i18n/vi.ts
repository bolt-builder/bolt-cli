export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu Bolt",
  ...
  "desktop.recovery.loadFailed": "Không tải được Bolt",
  "desktop.recovery.terminated": "Cửa sổ Bolt đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "Bolt không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được Bolt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Bolt chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật Bolt nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong Bolt.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong Bolt.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong Bolt.",
  ...
  "dialog.server.description": "Chuyển máy chủ Bolt mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra Bolt trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật Bolt...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật Bolt trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật Bolt trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật Bolt",
  "wsl.onboarding.opencodeReadyIn": "Bolt đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "Bolt đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt Bolt trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt Bolt",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Bolt chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi Bolt có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "Bolt không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại Bolt.",
  ...
  "help.tabs.introduction": "Bolt Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của Bolt ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm Bolt",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: Bolt chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "Bolt bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ Bolt bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho Bolt",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của Bolt trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem Bolt tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của Bolt.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi Bolt khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của Bolt.",
  ...
  "settings.gateways.title": "Gateway",
  "settings.gateways.description": "Kết nối một gateway AI để truy cập nhiều mô hình qua một khóa API duy nhất, bao gồm cả các mô hình miễn phí.",
  "settings.gateways.tag.connected": "Đã kết nối",
  "settings.gateways.note.kilo": "Gateway tương thích OpenRouter với các mô hình miễn phí được định tuyến tự động",
  "settings.gateways.note.zoo": "Gateway cộng đồng từ dự án Zoo Code",
  "settings.gateways.connect.title": "Kết nối {{gateway}}",
  "settings.gateways.connect.description": "Dán khóa API {{gateway}} của bạn để kết nối các mô hình của nó.",
