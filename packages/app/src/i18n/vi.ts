export const dict = {
  ...
  "settings.gateways.title": "Cổng kết nối",
  "settings.gateways.description":
    "Kết nối một cổng AI để truy cập nhiều mô hình bằng một khóa API duy nhất, bao gồm cả các mô hình miễn phí.",
  "settings.gateways.tag.connected": "Đã kết nối",
  "settings.gateways.note.kilo": "Cổng tương thích OpenRouter với các mô hình miễn phí được định tuyến tự động",
  "settings.gateways.note.zoo": "Cổng cộng đồng từ dự án Zoo Code",
