export const dict = {
  ...
  "settings.gateways.title": "ጌትዌይዎች",
  "settings.gateways.description": "ነፃ ሞዴሎችን ጨምሮ ብዙ ሞዴሎችን በአንድ ኤፒአይ ቁልፍ ለመድረስ የ AI ጌትዌይ ያገናኙ።",
  "settings.gateways.tag.connected": "ተገናኝቷል",
  "settings.gateways.note.kilo": "ከ OpenRouter ጋር ተኳሃኝ የሆነ ጌትዌይ ከነፃ በራስ-ሰር የሚመሩ ሞዴሎች ጋር",
  "settings.gateways.note.zoo": "ከ Zoo Code ፕሮጀክት የመጣ የማህበረሰብ ጌትዌይ",
  "settings.gateways.connect.title": "{{gateway}} ያገናኙ",
  "settings.gateways.connect.description": "ሞዴሎቹን ለማገናኘት የ {{gateway}} ኤፒአይ ቁልፍዎን ይለጥፉ።",
