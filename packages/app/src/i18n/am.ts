export const dict = {
  ...
  "settings.gateways.title": "ጌትዌዮች",
  "settings.gateways.description": "ነፃ ሞዴሎችን ጨምሮ ብዙ ሞዴሎችን በአንድ API ቁልፍ ለመድረስ የ AI ጌትዌይ ያገናኙ።",
  "settings.gateways.tag.connected": "የተገናኘ",
  "settings.gateways.note.kilo": "ነፃ በራስ-ሰር የሚመሩ ሞዴሎች ያሉት ከ OpenRouter ጋር ተኳሃኝ ጌትዌይ",
