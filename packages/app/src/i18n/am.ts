export const dict = {
  ...
  "settings.gateways.title": "መተላለፊያዎች",
  "settings.gateways.description": "ብዙ ሞዴሎችን በአንድ API ቁልፍ ለመድረስ የ AI መተላለፊያ ያገናኙ፣ ነፃ ሞዴሎችንም ጨምሮ።",
  "settings.gateways.tag.connected": "ተገናኝቷል",
  "settings.gateways.note.kilo": "ከ OpenRouter ጋር ተኳሃኝ የሆነ መተላለፊያ በራስ-ሰር የሚመሩ ነፃ ሞዴሎች ያሉት",
  "settings.gateways.note.zoo": "ከ Zoo Code ፕሮጀክት የማህበረሰብ መተላለፊያ",
  "settings.gateways.connect.title": "{{gateway}} ያገናኙ",
  "settings.gateways.connect.description": "ሞዴሎቹን ለማገናኘት የ {{gateway}} API ቁልፍዎን ይለጥፉ።",
