export const dict = {
  ...
  "settings.gateways.description": "በአንድ API ቁልፍ ነፃ ሞዴሎችን ጨምሮ ብዙ ሞዴሎችን ለመድረስ የ AI ጌትዌይ ያገናኙ።",
  "settings.gateways.tag.connected": "የተገናኘ",
  "settings.gateways.note.kilo": "ነፃ በራስ-ሰር የሚመሩ ሞዴሎች ያሉት ከ OpenRouter ጋር ተኳሃኝ የሆነ ጌትዌይ",
  "settings.gateways.note.zoo": "ከ Zoo Code ፕሮጀክት የማህበረሰብ ጌትዌይ",
  "settings.gateways.connect.title": "{{gateway}} አገናኝ",
