export const dict = {
  ...
  "settings.gateways.description": "ነፃ ሞዴሎችን ጨምሮ ብዙ ሞዴሎችን በአንድ የAPI ቁልፍ ለመድረስ የAI ጌትዌይ ያገናኙ።",
  "settings.gateways.tag.connected": "ተገናኝቷል",
  "settings.gateways.note.kilo": "ነፃ በራስ-ሰር የሚመሩ ሞዴሎች ያሉት OpenRouter-ተኳሃኝ ጌትዌይ",
  "settings.gateways.note.zoo": "ከZoo Code ፕሮጀክት የመጣ የማህበረሰብ ጌትዌይ",
