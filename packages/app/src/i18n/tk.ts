export const dict = {
  ...
  "settings.gateways.title": "Geçelgeler",
  "settings.gateways.description":
    "Bir API açary bilen mugt modelleri hem goşmak bilen köp modele girmek üçin AI geçelgesini birikdiriň.",
  "settings.gateways.tag.connected": "Birikdirildi",
  "settings.gateways.note.kilo": "Mugt awtomatik ugrukdyrylýan modelli OpenRouter bilen utgaşykly geçelge",
  "settings.gateways.note.zoo": "Zoo Code taslamasyndan jemgyýet geçelgesi",
  "settings.gateways.connect.title": "{{gateway}} birikdir",
