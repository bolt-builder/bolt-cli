export const dict = {
  ...
  "settings.gateways.description":
    "Bir API açary arkaly mugt modeller bilen birlikde köp modele girmek üçin AI derwezesini birikdiriň.",
  ...
  "settings.gateways.note.zoo": "Zoo Code taslamasyndan jemgyýet derwezesi",
  "settings.gateways.connect.title": "{{gateway}} birikdiriň",
