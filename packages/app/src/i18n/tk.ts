export const dict = {
  ...
  "settings.gateways.title": "Şlýuzlar",
  "settings.gateways.description":
    "Bir API açary bilen köp modele, şol sanda mugt modellere elýeterlilik üçin AI şlýuzyny birikdiriň.",
  "settings.gateways.tag.connected": "Birikdirildi",
  "settings.gateways.note.kilo": "Mugt awtomatik ugrukdyrylýan modelli OpenRouter bilen utgaşykly şlýuz",
  "settings.gateways.note.zoo": "Zoo Code taslamasynyň jemgyýetçilik şlýuzy",
