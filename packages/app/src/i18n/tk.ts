export const dict = {
  ...
  "settings.gateways.title": "Derwezeler",
  "settings.gateways.description": "Bir API açary bilen köp modele, şol sanda mugt modellere girmek üçin AI derwezesini birikdiriň.",
  "settings.gateways.tag.connected": "Birikdirildi",
  "settings.gateways.note.kilo": "Mugt awtomatik ugrukdyrylýan modelli OpenRouter bilen utgaşykly derweze",
  "settings.gateways.note.zoo": "Zoo Code taslamasyndan jemgyýetçilik derwezesi",
  "settings.gateways.connect.title": "{{gateway}} birikdirmek",
  "settings.gateways.connect.description": "Onuň modellerini birikdirmek üçin {{gateway}} API açaryňyzy goýuň.",
