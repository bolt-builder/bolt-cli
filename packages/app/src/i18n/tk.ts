export const dict = {
  ...
  "settings.gateways.description":
    "Bir API açary bilen köp modele, şol sanda mugt modellere girmek üçin AI şlýuzyny birikdiriň.",
  "settings.gateways.tag.connected": "Birikdirildi",
  "settings.gateways.note.kilo": "Mugt awtomatik ugrukdyrylýan modelli OpenRouter bilen gabat gelýän şlýuz",
  "settings.gateways.note.zoo": "Zoo Code taslamasynyň jemgyýetçilik şlýuzy",
  "settings.gateways.connect.title": "{{gateway}} birikdiriň",
  "settings.gateways.connect.description": "Modellerini birikdirmek üçin {{gateway}} API açaryňyzy goýuň.",
