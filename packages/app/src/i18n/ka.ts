export const dict = {
  ...
  "settings.gateways.title": "კარიბჭეები",
  "settings.gateways.description": "დააკავშირეთ AI კარიბჭე, რომ ერთი API გასაღებით მიიღოთ წვდომა ბევრ მოდელზე, უფასო მოდელების ჩათვლით.",
  "settings.gateways.tag.connected": "დაკავშირებული",
  "settings.gateways.note.kilo": "OpenRouter-თან თავსებადი კარიბჭე უფასო ავტომატურად მარშრუტიზებული მოდელებით",
  "settings.gateways.note.zoo": "სათემო კარიბჭე Zoo Code პროექტიდან",
  "settings.gateways.connect.title": "{{gateway}}-ის დაკავშირება",
  "settings.gateways.connect.description": "ჩასვით თქვენი {{gateway}} API გასაღები მისი მოდელების დასაკავშირებლად.",
