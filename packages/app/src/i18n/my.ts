export const dict = {
  ...
  "settings.gateways.description": "API သော့တစ်ခုတည်းဖြင့် မော်ဒယ်များစွာကို အသုံးပြုနိုင်ရန် AI ဂိတ်ဝေးတစ်ခုကို ချိတ်ဆက်ပါ၊ အခမဲ့မော်ဒယ်များလည်း ပါဝင်သည်။",
  "settings.gateways.tag.connected": "ချိတ်ဆက်ထားသည်",
  "settings.gateways.note.kilo": "အခမဲ့ အလိုအလျောက်လမ်းကြောင်းသတ်မှတ်သော မော်ဒယ်များပါဝင်သည့် OpenRouter နှင့် တွဲဖက်အသုံးပြုနိုင်သော ဂိတ်ဝေး",
  "settings.gateways.note.zoo": "Zoo Code ပရောဂျက်မှ အသိုင်းအဝိုင်းဂိတ်ဝေး",
  "settings.gateways.connect.title": "{{gateway}} ချိတ်ဆက်ရန်",
  "settings.gateways.connect.description": "၎င်း၏မော်ဒယ်များကို ချိတ်ဆက်ရန် သင့် {{gateway}} API သော့ကို ကူးထည့်ပါ။",
