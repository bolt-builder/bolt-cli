export const dict = {
  ...
  "settings.gateways.description":
    "အခမဲ့မော်ဒယ်များအပါအဝင် မော်ဒယ်များစွာကို API ကီးတစ်ခုတည်းဖြင့် အသုံးပြုနိုင်ရန် AI ဂိတ်ဝေးကို ချိတ်ဆက်ပါ။",
  "settings.gateways.tag.connected": "ချိတ်ဆက်ထားသည်",
  "settings.gateways.note.kilo": "အခမဲ့ အလိုအလျောက်လမ်းကြောင်းသတ်မှတ်သော မော်ဒယ်များပါရှိသည့် OpenRouter-သဟဇာတ ဂိတ်ဝေး",
  "settings.gateways.note.zoo": "Zoo Code ပရောဂျက်မှ အသိုင်းအဝိုင်း ဂိတ်ဝေး",
  "settings.gateways.connect.title": "{{gateway}} ကို ချိတ်ဆက်ပါ။",
  "settings.gateways.connect.description": "၎င်း၏ မော်ဒယ်များကို ချိတ်ဆက်ရန် သင်၏ {{gateway}} API ကီးကို ကူးထည့်ပါ။",
