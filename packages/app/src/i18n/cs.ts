export const dict = {
  ...
  "settings.gateways.description":
    "Připojte AI bránu a získejte přístup k mnoha modelům, včetně bezplatných, pomocí jediného klíče API.",
  ...
  "settings.gateways.connect.description": "Vložte svůj klíč API {{gateway}} a připojte jeho modely.",
