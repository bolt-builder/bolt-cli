export const dict = {
  ...
  "settings.gateways.description":
    "Připojte AI bránu a získejte přístup k mnoha modelům pomocí jediného API klíče, včetně bezplatných modelů.",
  ...
  "settings.gateways.connect.description": "Vložte svůj API klíč {{gateway}} a připojte jeho modely.",
