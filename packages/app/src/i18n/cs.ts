export const dict = {
  ...
  "settings.gateways.description": "Připojte AI bránu a získejte přístup k mnoha modelům pomocí jediného API klíče, včetně bezplatných modelů.",
  "settings.gateways.tag.connected": "Připojeno",
  "settings.gateways.note.kilo": "Brána kompatibilní s OpenRouter s bezplatnými automaticky směrovanými modely",
  "settings.gateways.note.zoo": "Komunitní brána z projektu Zoo Code",
  "settings.gateways.connect.title": "Připojit {{gateway}}",
  "settings.gateways.connect.description": "Vložte svůj API klíč {{gateway}} pro připojení jeho modelů.",
