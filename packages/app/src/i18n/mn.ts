export const dict = {
  ...
  "settings.gateways.description":
    "Нэг API түлхүүрээр олон загварт, үнэгүй загваруудыг оруулаад, хандахын тулд AI гарц холбоно уу.",
  ...
  "settings.gateways.connect.description": "Загваруудыг нь холбохын тулд {{gateway}} API түлхүүрээ буулгана уу.",
