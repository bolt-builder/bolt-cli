export const dict = {
  ...
  "settings.gateways.description":
    "Нэг API түлхүүрээр олон загварт, үнэгүй загваруудыг оролцуулан, хандахын тулд AI гарц холбоно уу.",
  ...
  "settings.gateways.note.zoo": "Zoo Code төслийн олон нийтийн гарц",
  "settings.gateways.connect.title": "Холбох {{gateway}}",
