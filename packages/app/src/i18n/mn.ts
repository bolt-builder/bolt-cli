export const dict = {
  ...
  "settings.gateways.title": "Гарцууд",
  "settings.gateways.description": "Нэг API түлхүүрээр олон загварт хандахын тулд AI гарц холбоно уу, үнэгүй загварууд ч багтана.",
  "settings.gateways.tag.connected": "Холбогдсон",
  "settings.gateways.note.kilo": "OpenRouter-тэй нийцтэй гарц, үнэгүй автоматаар чиглүүлэгддэг загваруудтай",
  "settings.gateways.note.zoo": "Zoo Code төслийн нийгэмлэгийн гарц",
  "settings.gateways.connect.title": "{{gateway}} холбох",
  "settings.gateways.connect.description": "Түүний загваруудыг холбохын тулд {{gateway}} API түлхүүрээ буулгана уу.",
