export const dict = {
  ...
  "settings.gateways.description":
    "Нэг API түлхүүрээр олон загварт, түүний дотор үнэгүй загваруудад хандахын тулд AI гарц холбоно уу.",
  "settings.gateways.tag.connected": "Холбогдсон",
  "settings.gateways.note.kilo": "Үнэгүй автоматаар чиглүүлдэг загваруудтай, OpenRouter-тэй нийцтэй гарц",
