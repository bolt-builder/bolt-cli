export const dict = {
  ...
  "settings.gateways.title": "Դարպասներ",
  "settings.gateways.description": "Միացրեք AI դարպաս՝ մեկ API բանալիով բազմաթիվ մոդելների հասանելիության համար, ներառյալ անվճար մոդելները։",
  ...
  "settings.gateways.connect.title": "Միացնել {{gateway}}",
