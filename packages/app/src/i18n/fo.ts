export const dict = {
  ...
  "settings.gateways.note.kilo": "OpenRouter-sambærilig gátt við ókeypis sjálvvirknum modellum",
  "settings.gateways.note.zoo": "Felagsgátt frá Zoo Code verkætlanini",
  "settings.gateways.connect.title": "Samband {{gateway}}",
  "settings.gateways.connect.description": "Set tín {{gateway}} API-lykil inn fyri at binda modellirnar í.",
