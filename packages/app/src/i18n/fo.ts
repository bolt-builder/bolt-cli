export const dict = {
  ...
  "settings.gateways.description":
    "Teng eina AI-gátt fyri at fáa atgongd til nógvar fyrimyndir gjøgnum ein einstakan API-lykil, eisini ókeypis fyrimyndir.",
  "settings.gateways.tag.connected": "Tengt",
  "settings.gateways.note.kilo": "Gátt, sum er sambæra við OpenRouter, við ókeypis sjálvvirkið dirigeraðum fyrimyndum",
  "settings.gateways.note.zoo": "Samfelagsgátt frá Zoo Code verkætlanini",
  "settings.gateways.connect.title": "Tengja {{gateway}}",
  "settings.gateways.connect.description": "Set inn {{gateway}} API-lykilin hjá tær fyri at tengja fyrimyndir tess.",
