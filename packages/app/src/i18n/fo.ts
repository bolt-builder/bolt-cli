export const dict = {
  ...
  "settings.gateways.description":
    "Bind eina AI-gátt í fyri at fáa atgongd til nógvar modellir gjøgnum ein einstakan API-lykil, eisini ókeypis modellir.",
  "settings.gateways.tag.connected": "Bundið í",
  "settings.gateways.note.kilo":
    "Gátt, sum er sambærilig við OpenRouter, við ókeypis sjálvvirkandi dirigeraðum modellum",
  "settings.gateways.note.zoo": "Felagsgátt frá Zoo Code verkætlanini",
  "settings.gateways.connect.title": "Bind {{gateway}} í",
  "settings.gateways.connect.description": "Set tín {{gateway}} API-lykil inn fyri at binda modellir tess í.",
