export const dict = {
  ...
  "settings.gateways.description":
    "Bind eina AI-gátt saman fyri at fáa atgongd til nógvar fyrimyndir við einum API-lykli, eisini ókeypis fyrimyndir.",
  "settings.gateways.tag.connected": "Tengt",
  "settings.gateways.note.kilo": "Gátt, sum er sambærilig við OpenRouter, við ókeypis sjálvvirkandi beindum fyrimyndum",
  "settings.gateways.note.zoo": "Felagsskaparagátt frá Zoo Code verkætlanini",
  "settings.gateways.connect.title": "Samband {{gateway}}",
  "settings.gateways.connect.description": "Líma tín {{gateway}} API-lykil fyri at tengja fyrimyndir tess.",
