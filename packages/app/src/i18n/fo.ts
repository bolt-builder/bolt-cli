export const dict = {
  ...
  "settings.gateways.title": "Gáttir",
  "settings.gateways.description": "Bind eina AI-gátt í fyri at fáa atgongd til nógvar modellir við einum API-lykli, eisini ókeypis modellir.",
  "settings.gateways.tag.connected": "Sambundin",
  "settings.gateways.note.kilo": "Gátt sambærilig við OpenRouter við ókeypis sjálvvirkandi dirigeraðum modellum",
  "settings.gateways.note.zoo": "Felagsgátt frá Zoo Code verkætlanini",
  "settings.gateways.connect.title": "Bind {{gateway}} í",
  "settings.gateways.connect.description": "Set tín {{gateway}} API-lykil inn fyri at binda modellir hansara í.",
