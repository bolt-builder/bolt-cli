export const dict: Record<string, string> = {
  ...
  "settings.gateways.title": "ගේට්වේ",
  "settings.gateways.description":
    "නොමිලේ ආකෘති ඇතුළුව බොහෝ ආකෘතිවලට එක් API යතුරකින් ප්‍රවේශ වීමට AI ගේට්වේයක් සම්බන්ධ කරන්න.",
  "settings.gateways.tag.connected": "සම්බන්ධයි",
  "settings.gateways.note.kilo": "නොමිලේ ස්වයංක්‍රීයව මාර්ගගත වන ආකෘති සහිත OpenRouter-අනුකූල ගේට්වේ",
  "settings.gateways.note.zoo": "Zoo Code ව්‍යාපෘතියේ ප්‍රජා ගේට්වේ",
