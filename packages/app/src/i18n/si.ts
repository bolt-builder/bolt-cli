export const dict: Record<string, string> = {
  ...
  "settings.gateways.description":
    "නොමිලේ ආකෘති ඇතුළුව, තනි API යතුරක් හරහා බොහෝ ආකෘතිවලට ප්‍රවේශ වීමට AI ද්වාරයක් සම්බන්ධ කරන්න.",
  "settings.gateways.tag.connected": "සම්බන්ධිතයි",
  "settings.gateways.note.kilo": "නොමිලේ ස්වයංක්‍රීයව මාර්ගගත වන ආකෘති සහිත OpenRouter-ගැළපෙන ද්වාරය",
  "settings.gateways.note.zoo": "Zoo Code ව්‍යාපෘතියේ ප්‍රජා ද්වාරය",
  "settings.gateways.connect.title": "{{gateway}} සම්බන්ධ කරන්න",
  "settings.gateways.connect.description": "එහි ආකෘති සම්බන්ධ කිරීමට ඔබේ {{gateway}} API යතුර අලවන්න.",
