...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Bolt'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Bolt'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Bolt'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Bolt sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Bolt kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Bolt kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Bolt güncelleniyor...",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Bolt'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Bolt bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Bolt'u tekrar açın.",
  ...
  "toast.update.description": "Bolt'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Bolt ekibine",
  ...
  "sidebar.gettingStarted.line1": "Bolt ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Bolt Masaüstü",
  ...
  "settings.desktop.wsl.description": "Bolt sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Bolt'un görünüm dilini değiştirin",
  ...
  "settings.updates.row.startup.description": "Bolt başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Bolt'un en son sürümünü kullanıyorsunuz.",
  ...
  "settings.gateways.title": "Ağ geçitleri",
  "settings.gateways.description": "Ücretsiz modeller de dahil olmak üzere birçok modele tek bir API anahtarıyla erişmek için bir yapay zeka ağ geçidi bağlayın.",
