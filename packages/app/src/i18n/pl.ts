export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Bolt",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Bolt",
  "desktop.recovery.terminated": "Okno Bolt zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Bolt nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować Bolt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Bolt nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Bolt została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Bolt.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Bolt.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Bolt.",
  ...
  "dialog.server.description": "Przełącz serwer Bolt, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Bolt w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Bolt...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Bolt w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Bolt w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Bolt",
  "wsl.onboarding.opencodeReadyIn": "Bolt jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Bolt jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Bolt w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Bolt",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Bolt nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Bolt będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Bolt nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Bolt.",
  ...
  "help.tabs.introduction": "Bolt Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Bolt ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Bolt",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Bolt nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Bolt zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Bolt wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Bolt",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Bolt na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Bolt ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Bolt.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Bolt",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Bolt.",
  ...
  "settings.gateways.title": "Bramy",
  "settings.gateways.description": "Połącz bramę AI, aby uzyskać dostęp do wielu modeli za pomocą jednego klucza API, w tym modeli darmowych.",
  "settings.gateways.tag.connected": "Połączono",
  "settings.gateways.note.kilo": "Brama zgodna z OpenRouter z darmowymi modelami z automatycznym routingiem",
