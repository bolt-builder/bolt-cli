export const dict: Record<string, string> = {
  ...
  "settings.gateways.description":
    "একটি মাত্র API কী দিয়ে বিনামূল্যের মডেলসহ অনেক মডেল অ্যাক্সেস করতে একটি AI গেটওয়ে সংযোগ করুন।",
  "settings.gateways.tag.connected": "সংযুক্ত",
  "settings.gateways.note.kilo": "বিনামূল্যের স্বয়ংক্রিয়ভাবে রুট করা মডেলসহ OpenRouter-সামঞ্জস্যপূর্ণ গেটওয়ে",
  "settings.gateways.note.zoo": "Zoo Code প্রকল্পের কমিউনিটি গেটওয়ে",
  "settings.gateways.connect.title": "{{gateway}} সংযোগ করুন",
  "settings.gateways.connect.description": "এর মডেলগুলি সংযোগ করতে আপনার {{gateway}} API কী পেস্ট করুন।",
