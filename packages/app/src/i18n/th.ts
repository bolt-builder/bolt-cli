export const dict = {
  ...
  "desktop.recovery.loadFailed": "โหลด Bolt ไม่สำเร็จ",
  "desktop.recovery.terminated": "หน้าต่าง Bolt หยุดทำงานโดยไม่คาดคิด",
  "desktop.recovery.unresponsive": "Bolt ไม่ตอบสนอง",
  ...
  "desktop.wsl.error.installOpencode": "การติดตั้ง Bolt ล้มเหลว",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "ไม่ได้ติดตั้ง Bolt ใน {{distro}}",
  "desktop.wsl.error.updateVersion":
    "อัปเดต Bolt เสร็จแล้ว แต่ {{distro}} ยังคงรายงานเวอร์ชัน {{installed}} ทั้งที่ควรเป็น {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Bolt",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรับรหัสการอนุญาตสำหรับเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Bolt",
  ...
  "provider.connect.oauth.auto.visit.suffix": " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Bolt",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ Bolt ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "wsl.onboarding.checkingOpencode": "กำลังตรวจสอบ Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "กำลังตรวจสอบ Bolt ใน {{distro}}...",
  "wsl.onboarding.updatingOpencode": "กำลังอัปเดต Bolt...",
  "wsl.onboarding.updatingOpencodeIn": "กำลังอัปเดต Bolt ใน {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "อัปเดต Bolt ใน {{distro}}",
  "wsl.onboarding.updateOpencode": "อัปเดต Bolt",
  "wsl.onboarding.opencodeReadyIn": "Bolt พร้อมใช้งานใน {{distro}} แล้ว",
  "wsl.onboarding.opencodeReady": "Bolt พร้อมใช้งานแล้ว",
  "wsl.onboarding.installOpencodeIn": "ติดตั้ง Bolt ใน {{distro}}",
  "wsl.onboarding.installOpencode": "ติดตั้ง Bolt",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ยังไม่ได้ติดตั้ง Bolt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ Bolt จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "Bolt ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด Bolt อีกครั้ง",
  ...
  "help.tabs.introduction": "ตอนนี้ Bolt Desktop สร้างขึ้นโดยใช้แท็บเป็นหลัก",
  "help.tabs.sessions":
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ Bolt ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม Bolt",
  ...
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า Bolt ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "Bolt รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ Bolt ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ Bolt",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งรูปลักษณ์ของ Bolt บนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ Bolt ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งธีมของ Bolt",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ Bolt เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน Bolt เวอร์ชันล่าสุด",
  ...
  "settings.gateways.title": "เกตเวย์",
  "settings.gateways.description": "เชื่อมต่อเกตเวย์ AI เพื่อเข้าถึงโมเดลจำนวนมากด้วยคีย์ API เพียงคีย์เดียว รวมถึงโมเดลฟรี",
  "settings.gateways.tag.connected": "เชื่อมต่อแล้ว",
  "settings.gateways.note.kilo": "เกตเวย์ที่รองรับ OpenRouter พร้อมโมเดลฟรีที่กำหนดเส้นทางอัตโนมัติ",
  "settings.gateways.note.zoo": "เกตเวย์ชุมชนจากโปรเจกต์ Zoo Code",
  "settings.gateways.connect.title": "เชื่อมต่อ {{gateway}}",
  "settings.gateways.connect.description": "วางคีย์ API ของ {{gateway}} เพื่อเชื่อมต่อโมเดลของบริการนี้",
