export const dict: Record<string, string> = {
  ...
  "settings.gateways.description":
    "नि:शुल्क मोडेलहरूसहित धेरै मोडेलहरूमा एउटै API कुञ्जीबाट पहुँच गर्न AI गेटवे जडान गर्नुहोस्।",
  "settings.gateways.tag.connected": "जडान गरिएको",
  "settings.gateways.note.kilo": "नि:शुल्क स्वचालित रूपमा राउट गरिएका मोडेलहरूसहितको OpenRouter-अनुकूल गेटवे",
