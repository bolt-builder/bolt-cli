export const dict: Record<string, string> = {
  ...
  "settings.gateways.description":
    "एउटै API कुञ्जीबाट निःशुल्क मोडेलहरूसहित धेरै मोडेलहरूमा पहुँच गर्न AI गेटवे जडान गर्नुहोस्।",
  "settings.gateways.tag.connected": "जोडिएको",
  "settings.gateways.note.kilo": "निःशुल्क स्वचालित रूपमा रुट गरिएका मोडेलहरूसहितको OpenRouter-अनुकूल गेटवे",
  "settings.gateways.note.zoo": "Zoo Code परियोजनाको सामुदायिक गेटवे",
  "settings.gateways.connect.title": "जडान गर्नुहोस् {{gateway}}",
