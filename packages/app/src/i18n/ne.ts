export const dict: Record<string, string> = {
  ...
  "settings.gateways.title": "गेटवेहरू",
  "settings.gateways.description": "एउटै API कुञ्जीबाट धेरै मोडेलहरूमा पहुँच गर्न AI गेटवे जडान गर्नुहोस्, निःशुल्क मोडेलहरू सहित।",
  "settings.gateways.tag.connected": "जडान भयो",
  "settings.gateways.note.kilo": "निःशुल्क स्वचालित रूपमा रुट गरिएका मोडेलहरू सहितको OpenRouter-अनुकूल गेटवे",
  "settings.gateways.note.zoo": "Zoo Code परियोजनाको सामुदायिक गेटवे",
  "settings.gateways.connect.title": "{{gateway}} जडान गर्नुहोस्",
  "settings.gateways.connect.description": "यसका मोडेलहरू जडान गर्न आफ्नो {{gateway}} API कुञ्जी टाँस्नुहोस्।",
