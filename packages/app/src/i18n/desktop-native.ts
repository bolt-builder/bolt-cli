...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "Bolt failed to load",
  "desktop.recovery.terminated": "Bolt window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Bolt is not responding",
