export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in Bolt.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in Bolt.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in Bolt.",
  ...
  "dialog.server.description": "Cambia il server Bolt a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo Bolt in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento Bolt...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento Bolt in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna Bolt in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna Bolt",
  "wsl.onboarding.opencodeReadyIn": "Bolt è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Bolt è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa Bolt in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa Bolt",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Bolt non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che Bolt possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "Bolt non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired": "Riavvia Windows per completare l'installazione WSL, quindi riapri Bolt.",
  ...
  "help.tabs.introduction": "Bolt Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di Bolt ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Bolt",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: Bolt non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "Bolt include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server Bolt all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Bolt",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Bolt sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Bolt segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Bolt.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Bolt",
  ...
  "settings.updates.toast.latest.title": "Bolt è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Bolt.",
  ...
  "settings.gateways.description": "Connetti un gateway AI per accedere a molti modelli con un'unica chiave API, inclusi modelli gratuiti.",
  "settings.gateways.tag.connected": "Connesso",
  "settings.gateways.note.kilo": "Gateway compatibile con OpenRouter con modelli gratuiti instradati automaticamente",
  "settings.gateways.note.zoo": "Gateway della community dal progetto Zoo Code",
  ...
  "desktop.menu.documentation": "Documentazione di Bolt",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Bolt",
  "desktop.recovery.terminated": "La finestra di Bolt si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "Bolt non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di Bolt non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Bolt non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di Bolt è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
