export const dict = {
  ...
  "settings.gateways.description": "އެއް API ކީއަކުން ގިނަ މޮޑެލްތަކަށް އެކްސެސްވުމަށް AI ގޭޓްވޭއެއް ގުޅުއްވާ، ހިލޭ މޮޑެލްތައް ވެސް ހިމެނޭގޮތަށް.",
  "settings.gateways.tag.connected": "ގުޅިފައި",
  "settings.gateways.note.kilo": "ހިލޭ އޮޓޯ-ރޫޓެޑް މޮޑެލްތަކާއެކު OpenRouter އާ އެއްގޮތް ގޭޓްވޭ",
  "settings.gateways.note.zoo": "Zoo Code ޕްރޮޖެކްޓްގެ ކޮމިއުނިޓީ ގޭޓްވޭ",
  "settings.gateways.connect.title": "{{gateway}} ގުޅުއްވާ",
  "settings.gateways.connect.description": "އޭގެ މޮޑެލްތައް ގުޅުވުމަށް ތިޔަ {{gateway}} API ކީ ޕޭސްޓް ކުރައްވާ.",
