export const dict = {
  ...
  "settings.gateways.description":
    "އެއް API ކީއަކުން ހިލޭ މޮޑެލްތައް ހިމެނޭ ގޮތަށް ގިނަ މޮޑެލްތަކަށް ވާސިލުވުމަށް AI ގޭޓްވޭއެއް ގުޅުވާށެވެ.",
  "settings.gateways.tag.connected": "ގުޅިފައި",
  "settings.gateways.note.kilo": "ހިލޭ އޮޓޯ-ރޫޓެޑް މޮޑެލްތައް ހިމެނޭ OpenRouter އާއި އެއްގޮތްވާ ގޭޓްވޭ",
  "settings.gateways.note.zoo": "Zoo Code ޕްރޮޖެކްޓްގެ ކޮމިއުނިޓީ ގޭޓްވޭ",
  "settings.gateways.connect.title": "{{gateway}} ގުޅުވާށެވެ",
  "settings.gateways.connect.description": "މޮޑެލްތައް ގުޅުވުމަށް {{gateway}} API ކީ ޕޭސްޓް ކޮށްލާށެވެ.",
