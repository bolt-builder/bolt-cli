export const dict = {
  ...
  "settings.gateways.description":
    "އެއް API ކީއަކުން ހިލޭ މޮޑެލްތައް ހިމެނޭހެން ގިނަ މޮޑެލްތައް ބޭނުންކުރުމަށް AI ގޭޓްވޭއެއް ގުޅުވާށެވެ.",
  "settings.gateways.tag.connected": "ގުޅިފައި",
  "settings.gateways.note.kilo": "ހިލޭ އޮޓޯ-ރޫޓް މޮޑެލްތަކާއެކު OpenRouter އާ އެއްގޮތް ގޭޓްވޭ",
  "settings.gateways.note.zoo": "Zoo Code ޕްރޮޖެކްޓްގެ ކޮމިއުނިޓީ ގޭޓްވޭ",
  "settings.gateways.connect.title": "{{gateway}} ގުޅުވާށެވެ",
  "settings.gateways.connect.description": "އޭގެ މޮޑެލްތައް ގުޅުވުމަށް ތިޔަ {{gateway}} API ކީ ޕޭސްޓްކުރާށެވެ.",
