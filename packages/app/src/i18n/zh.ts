...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Bolt 加载失败",
  "desktop.recovery.terminated": "Bolt 窗口意外终止",
  "desktop.recovery.unresponsive": "Bolt 未响应",
  ...
  "desktop.wsl.error.installOpencode": "Bolt 安装失败",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 Bolt 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 Bolt 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 Bolt 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 Bolt 服务器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 Bolt...",
  "wsl.onboarding.updatingOpencode": "正在更新 Bolt...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 Bolt...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 Bolt。",
  "wsl.onboarding.updateOpencode": "更新 Bolt",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 Bolt 已就绪。",
  "wsl.onboarding.opencodeReady": "Bolt 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 Bolt。",
  "wsl.onboarding.installOpencode": "安装 Bolt",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 Bolt",
  ...
  "wsl.onboarding.wslNotInstalled.description": "Bolt 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "Bolt 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 Bolt。",
  ...
  "help.tabs.introduction": "Bolt Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Bolt 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Bolt 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：Bolt 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Bolt 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Bolt 服务器。",
  ...
  "settings.general.row.language.description": "更改 Bolt 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 Bolt 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Bolt 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Bolt 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Bolt 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Bolt。",
  ...
  "settings.gateways.description": "连接 AI 网关，即可通过单个 API 密钥访问众多模型，包括免费模型。",
  "settings.gateways.tag.connected": "已连接",
  "settings.gateways.note.kilo": "与 OpenRouter 兼容的网关，提供免费的自动路由模型",
  "settings.gateways.note.zoo": "来自 Zoo Code 项目的社区网关",
  "settings.gateways.connect.title": "连接 {{gateway}}",
  "settings.gateways.connect.description": "粘贴 {{gateway}} API 密钥以连接其模型。",
