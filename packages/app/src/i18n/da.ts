export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Bolt.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Bolt.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Bolt.",
  ...
  "dialog.server.description": "Skift hvilken Bolt-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Bolt i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Bolt...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Bolt i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Bolt i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Bolt",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Bolt er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Bolt kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Bolt kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Bolt igen.",
  ...
  "toast.update.description": "En ny version af Bolt ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Bolt-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Bolt understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Bolt inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Bolt-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Bolt",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Bolt ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Bolt skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Bolts tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Bolt starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Bolt.",
  ...
  "settings.gateways.description": "Forbind en AI-gateway for at få adgang til mange modeller med én enkelt API-nøgle, herunder gratis modeller.",
  "settings.gateways.tag.connected": "Forbundet",
  "settings.gateways.note.kilo": "OpenRouter-kompatibel gateway med gratis automatisk dirigerede modeller",
  "settings.gateways.note.zoo": "Fællesskabsgateway fra Zoo Code-projektet",
  "settings.gateways.connect.title": "Forbind {{gateway}}",
  "settings.gateways.connect.description": "Indsæt din {{gateway}} API-nøgle for at forbinde dens modeller.",
  ...
  "desktop.recovery.loadFailed": "Bolt kunne ikke indlæses",
  "desktop.recovery.terminated": "Bolt-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af Bolt mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Bolt er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Bolt er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Bolt Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
