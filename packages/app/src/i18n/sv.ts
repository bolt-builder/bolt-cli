export const dict = {
  ...
  "desktop.recovery.loadFailed": "Bolt kunde inte läsas in",
  "desktop.recovery.terminated": "Bolt-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Bolt svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av Bolt misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Bolt är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Bolt-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Bolt.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Bolt.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Bolt.",
  ...
  "dialog.server.description": "Växla vilken Bolt-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar Bolt i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar Bolt...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar Bolt i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera Bolt i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera Bolt",
  "wsl.onboarding.opencodeReadyIn": "Bolt är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Bolt är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera Bolt i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera Bolt",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Bolt är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Bolt kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Bolt kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Bolt igen.",
  ...
  "help.tabs.introduction": "Bolt Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Bolt ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Bolt-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Bolt stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "Bolt innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör Bolt-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Bolt",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Bolt ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Bolt följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Bolts tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Bolt startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Bolt.",
  ...
  "settings.gateways.title": "Gatewayer",
  "settings.gateways.description": "Anslut en AI-gateway för att få tillgång till många modeller med en enda API-nyckel, inklusive gratismodeller.",
  "settings.gateways.tag.connected": "Ansluten",
  "settings.gateways.note.kilo": "OpenRouter-kompatibel gateway med gratis automatiskt dirigerade modeller",
  "settings.gateways.note.zoo": "Communitygateway från Zoo Code-projektet",
