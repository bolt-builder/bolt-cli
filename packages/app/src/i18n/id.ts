export const dict = {
  ...
  "settings.gateways.description":
    "Hubungkan gateway AI untuk mengakses banyak model melalui satu kunci API, termasuk model gratis.",
  "settings.gateways.tag.connected": "Terhubung",
  "settings.gateways.note.kilo":
    "Gateway yang kompatibel dengan OpenRouter dengan model gratis yang dirutekan otomatis",
