export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Bolt",
  ...
  "desktop.recovery.loadFailed": "Bolt gagal dimuat",
  "desktop.recovery.terminated": "Jendela Bolt berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Bolt tidak merespons",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Bolt.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Bolt.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Bolt.",
  ...
  "dialog.server.description": "Ganti server Bolt mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa Bolt di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui Bolt...",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Bolt dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Bolt tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Bolt.",
  ...
  "help.tabs.introduction": "Bolt Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Bolt ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Bolt",
  ...
  "sidebar.gettingStarted.line1": "Bolt menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Bolt di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Bolt",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Bolt di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Bolt mengikuti tema sistem, terang, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Bolt.",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Bolt diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Bolt.",
  ...
  "settings.gateways.description": "Hubungkan gateway AI untuk mengakses banyak model melalui satu kunci API, termasuk model gratis.",
  "settings.gateways.tag.connected": "Terhubung",
  "settings.gateways.note.kilo": "Gateway yang kompatibel dengan OpenRouter dengan model gratis yang dirutekan otomatis",
  "settings.gateways.note.zoo": "Gateway komunitas dari proyek Zoo Code",
  "settings.gateways.connect.title": "Hubungkan {{gateway}}",
  "settings.gateways.connect.description": "Tempel kunci API {{gateway}} Anda untuk menghubungkan model-modelnya.",
