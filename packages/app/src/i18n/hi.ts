export const dict = {
  ...
  "settings.gateways.description":
    "एक ही API कुंजी से कई मॉडल, जिनमें मुफ़्त मॉडल भी शामिल हैं, एक्सेस करने के लिए AI गेटवे कनेक्ट करें।",
  "settings.gateways.tag.connected": "कनेक्टेड",
  "settings.gateways.note.kilo": "मुफ़्त ऑटो-रूटेड मॉडल वाला OpenRouter-संगत गेटवे",
  "settings.gateways.note.zoo": "Zoo Code प्रोजेक्ट का कम्युनिटी गेटवे",
  "settings.gateways.connect.title": "{{gateway}} कनेक्ट करें",
  "settings.gateways.connect.description": "इसके मॉडल कनेक्ट करने के लिए अपनी {{gateway}} API कुंजी पेस्ट करें।",
