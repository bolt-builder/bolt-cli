export const dict = {
  ...
  "desktop.menu.documentation": "Bolt दस्तावेज़",
  ...
  "desktop.menu.ariaLabel": "Bolt मेन्यू",
  ...
  "desktop.recovery.loadFailed": "Bolt लोड नहीं हो सका",
  "desktop.recovery.terminated": "Bolt विंडो अनपेक्षित रूप से बंद हो गई",
  "desktop.recovery.unresponsive": "Bolt प्रतिसाद नहीं दे रहा है",
  ...
  "desktop.wsl.error.installOpencode": "Bolt इंस्टॉल नहीं हो सका",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} में Bolt इंस्टॉल नहीं है",
  "desktop.wsl.error.updateVersion":
    "Bolt अपडेट पूरा हो गया, लेकिन {{distro}} अब भी {{installed}} रिपोर्ट कर रहा है; अपेक्षित संस्करण {{expected}} है",
  ...
  "provider.connect.apiKey.description":
    "अपने खाते को कनेक्ट करने के लिए अपनी {{provider}} API कुंजी दर्ज करें और Bolt में {{provider}} मॉडल का उपयोग करें।",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " अपने खाते को कनेक्ट करने और Bolt में {{provider}} मॉडल का उपयोग करने के लिए अपना प्राधिकरण कोड प्राप्त करें।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " और अपने खाते को कनेक्ट करने तथा Bolt में {{provider}} मॉडल का उपयोग करने के लिए नीचे दिया गया कोड दर्ज करें।",
  ...
  "dialog.server.description": "स्विच करें कि यह ऐप किस Bolt सर्वर से कनेक्ट होता है।",
  ...
  "wsl.onboarding.checkingOpencode": "Bolt की जाँच हो रही है...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} में Bolt की जाँच हो रही है...",
  "wsl.onboarding.updatingOpencode": "Bolt अपडेट हो रहा है...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} में Bolt अपडेट हो रहा है...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} में Bolt को अपडेट करें।",
  "wsl.onboarding.updateOpencode": "Bolt को अपडेट करें",
  "wsl.onboarding.opencodeReadyIn": "Bolt {{distro}} में तैयार है।",
  "wsl.onboarding.opencodeReady": "Bolt तैयार है।",
  "wsl.onboarding.installOpencodeIn": "{{distro}} में Bolt स्थापित करें।",
  "wsl.onboarding.installOpencode": "Bolt स्थापित करें",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Bolt स्थापित नहीं है",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Bolt द्वारा WSL सर्वर जोड़ने से पहले WSL (Linux के लिए Windows सबसिस्टम) आवश्यक है",
  "wsl.onboarding.wslUnavailable.title": "WSL अनुपलब्ध है",
  "wsl.onboarding.wslUnavailable.description": "Bolt इस मशीन पर WSL को सत्यापित नहीं कर सका।",
  "wsl.onboarding.installWsl": "WSL स्थापित करें",
  "wsl.onboarding.windowsRestartRequired":
    "WSL की स्थापना समाप्त करने के लिए Windows को पुनरारंभ करें, फिर Bolt को फिर से खोलें।",
  ...
  "help.tabs.introduction": "Bolt Desktop अब टैब पर आधारित है।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Bolt ({{version}}) का एक नया संस्करण अब इंस्टॉल करने के लिए उपलब्ध है।",
  ...
  "error.page.report.prefix": "कृपया इस त्रुटि की रिपोर्ट Bolt टीम को करें",
  ...
  "error.chain.mcpFailed":
    'MCP सर्वर "{{name}}" विफल रहा। ध्यान दें, Bolt अभी तक MCP प्रमाणीकरण का समर्थन नहीं करता है।',
  ...
  "sidebar.gettingStarted.line1": "Bolt में निःशुल्क मॉडल शामिल है ताकि आप तुरंत शुरू कर सकें।",
  ...
  "settings.desktop.wsl.description": "Windows पर WSL के अंदर Bolt सर्वर चलाएँ।",
  ...
  "settings.general.row.language.description": "Bolt के लिए प्रदर्शन भाषा बदलें",
  ...
  "settings.general.row.appearance.description": "अनुकूलित करें कि Bolt आपके डिवाइस पर कैसा दिखता है",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description": "चुनें कि Bolt सिस्टम, हल्की या गहरी थीम में से किसका उपयोग करे",
  "settings.general.row.theme.title": "थीम",
  "settings.general.row.theme.description": "अनुकूलित करें कि Bolt की थीम कैसी है।",
  ...
  "settings.updates.row.startup.description": "Bolt लॉन्च होने पर अपने-आप अपडेट की जाँच करें",
  ...
  "settings.updates.toast.latest.description": "आप Bolt का नवीनतम संस्करण चला रहे हैं।",
  ...
  "settings.gateways.title": "गेटवे",
  "settings.gateways.description": "एक ही API कुंजी से कई मॉडलों तक पहुँचने के लिए एक AI गेटवे कनेक्ट करें, जिसमें मुफ़्त मॉडल भी शामिल हैं।",
  "settings.gateways.tag.connected": "कनेक्टेड",
  "settings.gateways.note.kilo": "मुफ़्त ऑटो-रूटेड मॉडलों के साथ OpenRouter-संगत गेटवे",
  "settings.gateways.note.zoo": "Zoo Code प्रोजेक्ट का कम्युनिटी गेटवे",
  "settings.gateways.connect.title": "{{gateway}} कनेक्ट करें",
  "settings.gateways.connect.description": "इसके मॉडलों को कनेक्ट करने के लिए अपनी {{gateway}} API कुंजी पेस्ट करें।",
