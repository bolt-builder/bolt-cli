export const dict = {
  ...
  "settings.gateways.title": "Prehodi",
  "settings.gateways.description": "Povežite prehod AI za dostop do številnih modelov z enim ključem API, vključno z brezplačnimi modeli.",
