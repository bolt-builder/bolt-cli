export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Boltissa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Boltissa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Boltissa.",
  ...
  "dialog.server.description": "Vaihda Bolt-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan Boltia...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan Boltia kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään Boltia...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään Boltia kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä Bolt jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä Bolt",
  "wsl.onboarding.opencodeReadyIn": "Bolt on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "Bolt on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna Bolt jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna Bolt",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Boltia ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Bolt voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Bolt ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Bolt uudelleen.",
  ...
  "toast.update.description": "Boltin uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Bolt-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Bolt ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "Bolt sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita Bolt-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda Boltin näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Bolt näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Bolt järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Boltin teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Bolt käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät Boltin uusinta versiota.",
  ...
  "settings.gateways.description": "Yhdistä tekoäly-yhdyskäytävä käyttääksesi useita malleja yhdellä API-avaimella, mukaan lukien ilmaiset mallit.",
  "settings.gateways.tag.connected": "Yhdistetty",
  "settings.gateways.note.kilo": "OpenRouter-yhteensopiva yhdyskäytävä, jossa on ilmaisia automaattisesti reititettyjä malleja",
  "settings.gateways.note.zoo": "Yhteisön yhdyskäytävä Zoo Code -projektista",
  ...
  "desktop.menu.documentation": "Bolt-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Bolt-valikko",
  ...
  "desktop.recovery.loadFailed": "Boltin lataaminen epäonnistui",
  "desktop.recovery.terminated": "Bolt-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Bolt ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "Boltin asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Boltia ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Boltin päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "Bolt Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
