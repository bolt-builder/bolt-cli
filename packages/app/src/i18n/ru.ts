export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в Bolt.",
  ...
  "dialog.server.description": "Переключите сервер Bolt к которому подключается приложение.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в Bolt требуется WSL (Windows Subsystem for Linux)",
  ...
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что Bolt пока не поддерживает MCP авторизацию.',
  ...
  "settings.general.row.appearance.description": "Настройте как Bolt выглядит на вашем устройстве",
