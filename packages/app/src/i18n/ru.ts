export const dict = {
  ...
  "desktop.menu.documentation": "Документация Bolt",
  ...
  "desktop.recovery.loadFailed": "Не удалось загрузить Bolt",
  "desktop.recovery.terminated": "Окно Bolt неожиданно завершило работу",
  "desktop.recovery.unresponsive": "Bolt не отвечает",
  ...
  "desktop.wsl.error.installOpencode": "Не удалось установить Bolt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Bolt не установлен в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Обновление Bolt завершено, но {{distro}} по-прежнему сообщает версию {{installed}}; ожидалась {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Введите ключ API {{provider}}, чтобы подключить аккаунт и использовать модели {{provider}} в Bolt.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Bolt.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Bolt.",
  ...
  "dialog.server.description": "Выберите сервер Bolt, к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingOpencode": "Проверка Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "Проверка Bolt в {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Обновление Bolt...",
  "wsl.onboarding.updatingOpencodeIn": "Обновление Bolt в {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Обновите Bolt в {{distro}}.",
  "wsl.onboarding.updateOpencode": "Обновить Bolt",
  "wsl.onboarding.opencodeReadyIn": "Bolt в {{distro}} готов к работе.",
  "wsl.onboarding.opencodeReady": "Bolt готов к работе.",
  "wsl.onboarding.installOpencodeIn": "Установите Bolt в {{distro}}.",
  "wsl.onboarding.installOpencode": "Установить Bolt",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Bolt не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в Bolt требуется WSL (Подсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Bolt не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте Bolt.",
  ...
  "help.tabs.introduction": "Теперь работа в Bolt Desktop организована с помощью вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новая версия Bolt ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде Bolt",
  ...
  "error.chain.mcpFailed":
    'MCP-сервер "{{name}}" завершился с ошибкой. Обратите внимание: Bolt пока не поддерживает MCP-авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "Bolt включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер Bolt внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения Bolt",
  ...
  "settings.general.row.appearance.description": "Настройте внешний вид Bolt на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли Bolt системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Bolt.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске Bolt",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Bolt.",
  ...
  "settings.gateways.description": "Подключите AI-шлюз, чтобы получить доступ ко многим моделям по одному ключу API, включая бесплатные модели.",
  ...
  "settings.gateways.connect.title": "Подключить {{gateway}}",
  "settings.gateways.connect.description": "Вставьте ключ API {{gateway}}, чтобы подключить его модели.",
