export const dict = {
  ...
  "settings.gateways.title": "Премини",
  "settings.gateways.description": "Поврзете AI премин за пристап до многу модели преку еден API клуч, вклучувајќи и бесплатни модели.",
  "settings.gateways.tag.connected": "Поврзано",
  "settings.gateways.note.kilo": "Премин компатибилен со OpenRouter со бесплатни автоматски насочувани модели",
  "settings.gateways.note.zoo": "Премин на заедницата од проектот Zoo Code",
  "settings.gateways.connect.title": "Поврзи {{gateway}}",
  "settings.gateways.connect.description": "Залепете го вашиот {{gateway}} API клуч за да ги поврзете неговите модели.",
