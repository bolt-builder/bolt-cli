export const dict = {
  ...
  "settings.gateways.title": "Гејтвеи",
  "settings.gateways.description":
    "Поврзете AI гејтвеј за пристап до многу модели преку еден API клуч, вклучувајќи бесплатни модели.",
  "settings.gateways.tag.connected": "Поврзано",
  "settings.gateways.note.kilo": "Гејтвеј компатибилен со OpenRouter со бесплатни автоматски насочувани модели",
  "settings.gateways.note.zoo": "Гејтвеј на заедницата од проектот Zoo Code",
  "settings.gateways.connect.title": "Поврзете се {{gateway}}",
  "settings.gateways.connect.description": "Вметнете го вашиот {{gateway}} API клуч за да ги поврзете неговите модели.",
