...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Bolt zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Bolt zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Bolt zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den Bolt-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "Bolt wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "Bolt in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "Bolt wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "Bolt in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Bolt in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Bolt aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "Bolt ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "Bolt ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Bolt in {{distro}}.",
  "wsl.onboarding.installOpencode": "Bolt installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Bolt nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Bolt einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Bolt konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Bolt erneut.",
  ...
  "toast.update.description": "Eine neue Version von Bolt ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Bolt-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Bolt unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Bolt mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "Bolt enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Bolt-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Bolt ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Bolt auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description": "Wählen Sie, ob Bolt dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Bolt anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Bolt automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "Bolt ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Bolt wird verwendet.",
  ...
  "settings.gateways.description": "Verbinden Sie ein KI-Gateway, um mit einem einzigen API-Schlüssel auf viele Modelle zuzugreifen, einschließlich kostenloser Modelle.",
  ...
  "settings.gateways.note.zoo": "Community-Gateway aus dem Projekt Zoo Code",
  "settings.gateways.connect.title": "{{gateway}} verbinden",
  "settings.gateways.connect.description": "Fügen Sie Ihren {{gateway}}-API-Schlüssel ein, um dessen Modelle zu verbinden.",
  ...
  "desktop.recovery.loadFailed": "Bolt konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Bolt-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Bolt reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "Bolt-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Bolt ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Bolt-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "Bolt Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
