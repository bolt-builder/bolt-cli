...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Bolt.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Bolt.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Bolt.",
  ...
  "dialog.server.description": "Switch which Bolt server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Bolt in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Bolt...",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Bolt can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Bolt could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Bolt.",
  ...
  "toast.update.description": "A new version of Bolt ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Bolt team",
  ...
  "sidebar.gettingStarted.line1": "Bolt includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Bolt server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Bolt",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Bolt looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Bolt follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Bolt is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Bolt launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Bolt.",
  ...
  "settings.gateways.description":
    "Connect an AI gateway to access many models through a single API key, including free models.",
  "settings.gateways.tag.connected": "Connected",
  "settings.gateways.note.kilo": "OpenRouter-compatible gateway with free auto-routed models",
  "settings.gateways.note.zoo": "Community gateway from the Zoo Code project",
  "settings.gateways.connect.title": "Connect {{gateway}}",
  "settings.gateways.connect.description": "Paste your {{gateway}} API key to connect its models.",
