...
export const dict = {
  ...
  "settings.gateways.description": "Csatlakoztasson egy AI-átjárót, hogy egyetlen API-kulccsal sok modellhez férjen hozzá, beleértve az ingyenes modelleket is.",
