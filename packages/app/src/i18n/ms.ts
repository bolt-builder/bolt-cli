export const dict = {
  ...
  "settings.gateways.title": "Get laluan",
  "settings.gateways.description":
    "Sambungkan get laluan AI untuk mengakses banyak model melalui satu kunci API, termasuk model percuma.",
  "settings.gateways.tag.connected": "Disambungkan",
  "settings.gateways.note.kilo": "Get laluan serasi OpenRouter dengan model percuma yang dihalakan secara automatik",
  "settings.gateways.note.zoo": "Get laluan komuniti daripada projek Zoo Code",
  "settings.gateways.connect.title": "Sambungkan {{gateway}}",
  "settings.gateways.connect.description": "Tampal kunci API {{gateway}} anda untuk menyambungkan modelnya.",
