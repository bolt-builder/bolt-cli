export const dict = {
  ...
  "settings.gateways.title": "Gerbang",
  "settings.gateways.description": "Sambungkan gerbang AI untuk mengakses banyak model melalui satu kunci API, termasuk model percuma.",
  "settings.gateways.tag.connected": "Disambungkan",
  "settings.gateways.note.kilo": "Gerbang serasi OpenRouter dengan model percuma yang dihalakan secara automatik",
  "settings.gateways.note.zoo": "Gerbang komuniti daripada projek Zoo Code",
  "settings.gateways.connect.title": "Sambungkan {{gateway}}",
  "settings.gateways.connect.description": "Tampal kunci API {{gateway}} anda untuk menyambungkan model-modelnya.",
