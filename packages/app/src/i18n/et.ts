export const dict = {
  ...
  "settings.gateways.description":
    "Ühendage AI-lüüs, et pääseda ühe API-võtmega ligi paljudele mudelitele, sealhulgas tasuta mudelitele.",
  ...
  "settings.gateways.note.zoo": "Kogukonna lüüs Zoo Code'i projektist",
