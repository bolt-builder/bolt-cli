export const dict = {
  ...
  "settings.gateways.description":
    "Ühenda AI lüüs, et pääseda ühe API-võtmega ligi paljudele mudelitele, sealhulgas tasuta mudelitele.",
  ...
  "settings.gateways.connect.description": "Kleebi oma {{gateway}} API võti, et ühendada selle mudelid.",
