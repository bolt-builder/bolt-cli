export const dict = {
  ...
  "settings.gateways.title": "Lüüsid",
  "settings.gateways.description": "Ühendage AI-lüüs, et pääseda ühe API-võtmega ligi paljudele mudelitele, sealhulgas tasuta mudelitele.",
  "settings.gateways.tag.connected": "Ühendatud",
  "settings.gateways.note.kilo": "OpenRouteriga ühilduv lüüs tasuta automaatselt suunatavate mudelitega",
  "settings.gateways.note.zoo": "Zoo Code'i projekti kogukonnalüüs",
  "settings.gateways.connect.title": "Ühenda {{gateway}}",
  "settings.gateways.connect.description": "Kleepige oma {{gateway}} API-võti, et ühendada selle mudelid.",
