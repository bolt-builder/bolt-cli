export const dict = {
  ...
  "settings.gateways.description":
    "ایک ہی API کلید کے ذریعے متعدد ماڈلز، بشمول مفت ماڈلز، تک رسائی کے لیے AI گیٹ وے منسلک کریں۔",
  "settings.gateways.tag.connected": "منسلک",
  "settings.gateways.note.kilo": "مفت خودکار روٹ شدہ ماڈلز کے ساتھ OpenRouter سے مطابقت رکھنے والا گیٹ وے",
  "settings.gateways.note.zoo": "Zoo Code پروجیکٹ کا کمیونٹی گیٹ وے",
  "settings.gateways.connect.title": "{{gateway}} سے منسلک ہوں",
  "settings.gateways.connect.description": "اس کے ماڈلز منسلک کرنے کے لیے اپنی {{gateway}} API کلید پیسٹ کریں۔",
