export const dict = {
  ...
  "desktop.menu.documentation": "Bolt دستاویزات",
  ...
  "desktop.recovery.loadFailed": "Bolt لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "Bolt ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "Bolt جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOpencode": "Bolt کی تنصیب ناکام ہو گئی",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} میں Bolt انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "Bolt کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور Bolt میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور Bolt میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور Bolt میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس Bolt سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOpencode": "Bolt چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} میں Bolt چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencode": "Bolt کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} میں Bolt کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} میں Bolt کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpencode": "Bolt کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.opencodeReadyIn": "Bolt {{distro}} میں تیار ہے۔",
  "wsl.onboarding.opencodeReady": "Bolt تیار ہے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} میں Bolt انسٹال کریں۔",
  "wsl.onboarding.installOpencode": "Bolt انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Bolt انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ Bolt WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "Bolt اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر Bolt کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "Bolt Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Bolt ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم Bolt ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Bolt ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "Bolt میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر Bolt سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "Bolt کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.updates.row.startup.description": "Bolt لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ Bolt کا تازہ ترین ورژن چلا رہے ہیں۔",
  ...
  "settings.gateways.description": "ایک ہی API کلید کے ذریعے بہت سے ماڈلز تک رسائی کے لیے، بشمول مفت ماڈلز، ایک AI گیٹ وے منسلک کریں۔",
  "settings.gateways.tag.connected": "منسلک",
  "settings.gateways.note.kilo": "مفت خودکار روٹ شدہ ماڈلز کے ساتھ OpenRouter-مطابق گیٹ وے",
  "settings.gateways.note.zoo": "Zoo Code پروجیکٹ کی جانب سے کمیونٹی گیٹ وے",
  "settings.gateways.connect.title": "{{gateway}} سے منسلک ہوں",
  "settings.gateways.connect.description": "اس کے ماڈلز کو منسلک کرنے کے لیے اپنی {{gateway}} API کلید پیسٹ کریں۔",
