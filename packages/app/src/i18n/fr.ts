export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Bolt.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Bolt.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Bolt.",
  ...
  "dialog.server.description": "Changez le serveur Bolt auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Bolt dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Bolt...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Bolt dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Bolt dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Bolt",
  "wsl.onboarding.opencodeReadyIn": "Bolt est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Bolt est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Bolt dans {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Bolt non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Bolt puisse ajouter un serveur WSL",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Bolt",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Bolt dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Bolt",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Bolt sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Bolt suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Bolt.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Bolt",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Bolt.",
  ...
  "settings.gateways.description": "Connectez une passerelle d'IA pour accéder à de nombreux modèles avec une seule clé API, y compris des modèles gratuits.",
  "settings.gateways.tag.connected": "Connectée",
