export const dict = {
  ...
  "settings.gateways.description":
    "Savienojiet AI vārteju, lai ar vienu API atslēgu piekļūtu daudziem modeļiem, tostarp bezmaksas modeļiem.",
  ...
  "settings.gateways.connect.title": "Savienot {{gateway}}",
  "settings.gateways.connect.description": "Ielīmējiet savu {{gateway}} API atslēgu, lai savienotu tās modeļus.",
