export const dict = {
  ...
  "settings.gateways.description":
    "Pievienojiet AI vārteju, lai ar vienu API atslēgu piekļūtu daudziem modeļiem, tostarp bezmaksas modeļiem.",
  "settings.gateways.tag.connected": "Savienots",
  ...
  "settings.gateways.connect.description": "Ielīmējiet savu {{gateway}} API atslēgu, lai pievienotu tās modeļus.",
