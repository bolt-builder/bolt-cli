export const dict = {
  ...
  "settings.gateways.title": "Vārtejas",
  "settings.gateways.description": "Pievienojiet AI vārteju, lai ar vienu API atslēgu piekļūtu daudziem modeļiem, tostarp bezmaksas modeļiem.",
  "settings.gateways.tag.connected": "Savienota",
  "settings.gateways.note.kilo": "Ar OpenRouter saderīga vārteja ar bezmaksas automātiski maršrutētiem modeļiem",
  "settings.gateways.note.zoo": "Kopienas vārteja no Zoo Code projekta",
  "settings.gateways.connect.title": "Pievienot {{gateway}}",
  "settings.gateways.connect.description": "Ielīmējiet savu {{gateway}} API atslēgu, lai pievienotu tā modeļus.",
