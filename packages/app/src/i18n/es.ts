export const dict = {
  ...
  "dialog.server.description": "Cambiar a qué servidor de Bolt se conecta esta app.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Bolt",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Bolt no soporta autenticación MCP todavía.',
