export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Bolt.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Bolt.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Bolt.",
  ...
  "dialog.server.description": "Cambiar el servidor de Bolt al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Bolt en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Bolt...",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Bolt pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Bolt no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Bolt.",
  ...
  "toast.update.description": "Una nueva versión de Bolt ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Bolt",
  ...
  "sidebar.gettingStarted.line1": "Bolt incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Bolt dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Bolt",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Bolt en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Bolt sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Bolt.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Bolt",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Bolt.",
  ...
  "settings.gateways.description": "Conecta una pasarela de IA para acceder a muchos modelos con una sola clave de API, incluidos modelos gratuitos.",
  ...
  "settings.gateways.connect.description": "Pega tu clave de API de {{gateway}} para conectar sus modelos.",
