export const dict = {
  ...
  "settings.gateways.description":
    "Verbind een AI-gateway om met één API-sleutel toegang te krijgen tot veel modellen, waaronder gratis modellen.",
  ...
  "settings.gateways.note.zoo": "Community-gateway van het Zoo Code-project",
