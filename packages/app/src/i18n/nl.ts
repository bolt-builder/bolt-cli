export const dict = {
  ...
  "desktop.menu.documentation": "Bolt-documentatie",
  ...
  "desktop.recovery.loadFailed": "Bolt kan niet worden geladen",
  "desktop.recovery.terminated": "Het Bolt-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Bolt reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van Bolt is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Bolt is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Bolt-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Bolt te gebruiken.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Bolt te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Bolt te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke Bolt-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "Bolt controleren...",
  "wsl.onboarding.checkingOpencodeIn": "Bolt controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Bolt bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "Bolt bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk Bolt bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Bolt bijwerken",
  "wsl.onboarding.opencodeReadyIn": "Bolt is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Bolt is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer Bolt in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer Bolt",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Bolt niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Bolt een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Bolt kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Bolt opnieuw.",
  ...
  "help.tabs.introduction": "Bolt Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Bolt ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Bolt-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Bolt ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Bolt bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de Bolt-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Bolt",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Bolt eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Bolt het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Bolt aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Bolt wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Bolt is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Bolt.",
  ...
  "settings.gateways.description": "Verbind een AI-gateway om met één API-sleutel toegang te krijgen tot veel modellen, waaronder gratis modellen.",
  "settings.gateways.tag.connected": "Verbonden",
  "settings.gateways.note.kilo": "OpenRouter-compatibele gateway met gratis automatisch gerouteerde modellen",
  "settings.gateways.note.zoo": "Communitygateway van het Zoo Code-project",
  "settings.gateways.connect.title": "Verbinding maken met {{gateway}}",
  "settings.gateways.connect.description": "Plak je {{gateway}} API-sleutel om de bijbehorende modellen te verbinden.",
