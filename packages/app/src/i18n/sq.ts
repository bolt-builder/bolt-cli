export const dict = {
  ...
  "settings.gateways.description": "Lidhni një portë AI për të pasur qasje në shumë modele me një çelës të vetëm API, përfshirë modelet falas.",
  "settings.gateways.tag.connected": "E lidhur",
  "settings.gateways.note.kilo": "Portë e pajtueshme me OpenRouter me modele falas të drejtuara automatikisht",
  "settings.gateways.note.zoo": "Portë komunitare nga projekti Zoo Code",
