...
export const dict = {
  ...
  "settings.gateways.title": "Pristupnici",
  "settings.gateways.description": "Povežite AI pristupnik za pristup mnogim modelima putem jednog API ključa, uključujući besplatne modele.",
  "settings.gateways.tag.connected": "Povezano",
  "settings.gateways.note.kilo": "Pristupnik kompatibilan s OpenRouterom s besplatnim automatski usmjerenim modelima",
  "settings.gateways.note.zoo": "Pristupnik zajednice iz projekta Zoo Code",
  "settings.gateways.connect.title": "Poveži {{gateway}}",
  "settings.gateways.connect.description": "Zalijepite svoj {{gateway}} API ključ za povezivanje njegovih modela.",
