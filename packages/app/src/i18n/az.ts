export const dict = {
  ...
  "desktop.recovery.loadFailed": "Bolt yüklənə bilmədi",
  "desktop.recovery.terminated": "Bolt pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "Bolt cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "Bolt quraşdırılması uğursuz oldu",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Bolt {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "Bolt yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və Bolt-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və Bolt-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və Bolt-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu Bolt serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Bolt yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də Bolt yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "Bolt yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də Bolt yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də Bolt-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "Bolt-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "Bolt {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "Bolt hazırdır.",
  "wsl.onboarding.installOpencodeIn": "Bolt-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "Bolt quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Bolt quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Bolt WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "Bolt bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra Bolt-u yenidən açın.",
  ...
  "help.tabs.introduction": "Bolt Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Bolt-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı Bolt komandasına",
  ...
  "sidebar.gettingStarted.line1": "Bolt-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində Bolt serverini işlət.",
  ...
  "settings.general.row.language.description": "Bolt üçün ekran dilini dəyişdirin",
  ...
  "settings.updates.row.startup.description": "Bolt açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "Bolt-un ən son versiyasından istifadə edirsiniz.",
  ...
  "settings.gateways.title": "Şlüzlər",
  "settings.gateways.description": "Pulsuz modellər daxil olmaqla bir çox modelə tək API açarı ilə daxil olmaq üçün AI şlüzü qoşun.",
  "settings.gateways.tag.connected": "Qoşulub",
  "settings.gateways.note.kilo": "Pulsuz avtomatik yönləndirilən modellərlə OpenRouter-uyğun şlüz",
  "settings.gateways.note.zoo": "Zoo Code layihəsindən icma şlüzü",
  "settings.gateways.connect.title": "{{gateway}} şlüzünü qoş",
  "settings.gateways.connect.description": "Modellərinə qoşulmaq üçün {{gateway}} API açarınızı yapışdırın.",
