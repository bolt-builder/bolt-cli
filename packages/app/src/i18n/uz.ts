export const dict = {
  ...
  "settings.gateways.description":
    "Bitta API kaliti orqali bepul modellarni ham o'z ichiga olgan ko'plab modellarga kirish uchun AI shlyuzini ulang.",
  ...
  "settings.gateways.connect.title": "{{gateway}} ni ulang",
