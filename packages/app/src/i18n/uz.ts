export const dict = {
  ...
  "settings.gateways.description":
    "Bitta API kaliti orqali bepul modellarni ham qamrab olgan holda ko'plab modellarga kirish uchun AI shlyuzini ulang.",
  ...
  "settings.gateways.note.zoo": "Zoo Code loyihasidan hamjamiyat shlyuzi",
