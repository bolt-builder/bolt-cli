export const dict = {
  ...
  "settings.gateways.title": "Shlyuzlar",
  "settings.gateways.description": "Bitta API kaliti orqali ko'plab modellarga, jumladan bepul modellarga kirish uchun AI shlyuzini ulang.",
  "settings.gateways.tag.connected": "Ulangan",
  "settings.gateways.note.kilo": "Bepul avtomatik yo'naltiriladigan modellarga ega OpenRouter bilan mos shlyuz",
  "settings.gateways.note.zoo": "Zoo Code loyihasidan jamoat shlyuzi",
  "settings.gateways.connect.title": "{{gateway}}ni ulash",
  "settings.gateways.connect.description": "Uning modellarini ulash uchun {{gateway}} API kalitingizni joylashtiring.",
