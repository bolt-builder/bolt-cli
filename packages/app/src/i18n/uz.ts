export const dict = {
  ...
  "settings.gateways.description":
    "Bitta API kaliti orqali bepul modellarni ham qamrab olgan turli modellarga kirish uchun AI shlyuzini ulang.",
  "settings.gateways.tag.connected": "Ulangan",
  "settings.gateways.note.kilo": "Bepul avtomatik marshrutlangan modellarga ega OpenRouter bilan mos shlyuz",
  "settings.gateways.note.zoo": "Zoo Code loyihasining hamjamiyat shlyuzi",
  "settings.gateways.connect.title": "{{gateway}} ulash",
