export const dict = {
  ...
  "settings.gateways.description":
    "Bitta API kaliti orqali ko'plab modellarga, jumladan bepul modellarga kirish uchun AI shlyuzini ulang.",
  "settings.gateways.tag.connected": "Ulandi",
  "settings.gateways.note.kilo": "Bepul avtomatik yo'naltiriladigan modellarga ega OpenRouter-mos shlyuz",
  "settings.gateways.note.zoo": "Zoo Code loyihasining hamjamiyat shlyuzi",
  "settings.gateways.connect.title": "{{gateway}} ni ulang",
  "settings.gateways.connect.description": "Modellarini ulash uchun {{gateway}} API kalitingizni joylashtiring.",
