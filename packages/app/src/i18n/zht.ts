...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Bolt 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Bolt 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 並輸入以下程式碼，以連線你的帳戶並在 Bolt 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 Bolt 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 Bolt...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 Bolt 已就緒。",
  "wsl.onboarding.opencodeReady": "Bolt 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 Bolt。",
  "wsl.onboarding.installOpencode": "安裝 Bolt",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 Bolt",
  ...
  "wsl.onboarding.wslUnavailable.description": "Bolt 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 Bolt。",
  ...
  "toast.update.description": "Bolt 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Bolt 團隊",
  ...
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：Bolt 尚不支援 MCP 驗證。",
  ...
  "sidebar.gettingStarted.line1": "Bolt 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Bolt 伺服器。",
  ...
  "settings.general.row.language.description": "變更 Bolt 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 Bolt 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Bolt 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Bolt 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Bolt 啟動時自動檢查更新",
  ...
  "settings.gateways.title": "閘道",
  "settings.gateways.description": "連線 AI 閘道，即可透過單一 API 金鑰存取多種模型，包括免費模型。",
  "settings.gateways.tag.connected": "已連線",
  "settings.gateways.note.kilo": "與 OpenRouter 相容的閘道，提供免費的自動路由模型",
  "settings.gateways.note.zoo": "來自 Zoo Code 專案的社群閘道",
  "settings.gateways.connect.title": "連線 {{gateway}}",
  "settings.gateways.connect.description": "貼上你的 {{gateway}} API 金鑰以連線其模型。",
