export const dict = {
  ...
  "settings.gateways.description": "Συνδέστε μια πύλη AI για πρόσβαση σε πολλά μοντέλα μέσω ενός μόνο κλειδιού API, συμπεριλαμβανομένων δωρεάν μοντέλων.",
  "settings.gateways.tag.connected": "Συνδεδεμένη",
  "settings.gateways.note.kilo": "Πύλη συμβατή με OpenRouter με δωρεάν αυτόματα δρομολογούμενα μοντέλα",
