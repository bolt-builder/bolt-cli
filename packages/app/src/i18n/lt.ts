...
export const dict = {
  ...
  "settings.gateways.title": "Šliuzai",
  "settings.gateways.description": "Prijunkite AI šliuzą, kad vienu API raktu pasiektumėte daug modelių, įskaitant nemokamus modelius.",
