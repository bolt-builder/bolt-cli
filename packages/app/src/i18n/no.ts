...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Bolt.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Bolt.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Bolt.",
  ...
  "dialog.server.description": "Bytt hvilken Bolt-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Bolt ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Bolt-teamet",
  ...
  "sidebar.gettingStarted.line1": "Bolt inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Bolt-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Bolt",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Bolt ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Bolt skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Bolt.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Bolt starter",
  ...
  "settings.updates.toast.latest.title": "Bolt er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Bolt.",
  ...
  "settings.gateways.description": "Koble til en AI-gateway for å få tilgang til mange modeller med én enkelt API-nøkkel, inkludert gratis modeller.",
  "settings.gateways.tag.connected": "Tilkoblet",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Bolt i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Bolt...",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Bolt kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Bolt kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Bolt på nytt.",
