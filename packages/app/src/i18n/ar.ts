export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Bolt",
  "desktop.recovery.terminated": "توقفت نافذة Bolt بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Bolt لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت Bolt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Bolt غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Bolt، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Bolt.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Bolt.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Bolt.",
  ...
  "dialog.server.description": "تبديل خادم Bolt الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Bolt...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Bolt في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Bolt...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Bolt في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Bolt في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Bolt",
  "wsl.onboarding.opencodeReadyIn": "Bolt جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Bolt جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Bolt في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Bolt",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Bolt غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Bolt من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Bolt التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Bolt.",
  ...
  "help.tabs.introduction": "أصبح Bolt Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Bolt ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Bolt",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Bolt لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Bolt نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Bolt داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Bolt",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Bolt على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Bolt يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Bolt.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Bolt",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Bolt.",
  ...
  "settings.gateways.description": "اتصل ببوابة ذكاء اصطناعي للوصول إلى العديد من النماذج عبر مفتاح API واحد، بما في ذلك نماذج مجانية.",
  ...
  "settings.gateways.connect.description": "الصق مفتاح API الخاص بـ {{gateway}} لتوصيل نماذجه.",
