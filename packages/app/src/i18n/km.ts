export const dict = {
  ...
  "settings.gateways.description": "ភ្ជាប់ច្រកផ្លូវ AI ដើម្បីចូលប្រើម៉ូដែលជាច្រើនតាមរយៈសោ API តែមួយ រួមទាំងម៉ូដែលឥតគិតថ្លៃផងដែរ។",
  "settings.gateways.tag.connected": "បានភ្ជាប់",
  "settings.gateways.note.kilo": "ច្រកផ្លូវដែលឆបគ្នាជាមួយ OpenRouter ដែលមានម៉ូដែលឥតគិតថ្លៃដឹកនាំដោយស្វ័យប្រវត្តិ",
