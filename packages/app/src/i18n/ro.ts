export const dict = {
  ...
  "settings.gateways.description": "Conectați un gateway AI pentru a accesa multe modele printr-o singură cheie API, inclusiv modele gratuite.",
  ...
  "settings.gateways.connect.description": "Lipiți cheia API {{gateway}} pentru a conecta modelele sale.",
