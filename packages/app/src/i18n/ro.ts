export const dict = {
  ...
  "settings.gateways.title": "Gateway-uri",
  "settings.gateways.description":
    "Conectează un gateway AI pentru a accesa multe modele printr-o singură cheie API, inclusiv modele gratuite.",
  "settings.gateways.tag.connected": "Conectat",
  "settings.gateways.note.kilo": "Gateway compatibil OpenRouter cu modele gratuite rutate automat",
  "settings.gateways.note.zoo": "Gateway comunitar din proiectul Zoo Code",
  "settings.gateways.connect.title": "Conectează {{gateway}}",
  "settings.gateways.connect.description": "Lipește cheia API {{gateway}} pentru a-i conecta modelele.",
