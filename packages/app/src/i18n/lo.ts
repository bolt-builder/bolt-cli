export const dict = {
  ...
  "settings.gateways.title": "ປະຕູທາງຜ່ານ",
  "settings.gateways.description": "ເຊື່ອມຕໍ່ປະຕູທາງຜ່ານ AI ເພື່ອເຂົ້າເຖິງຫຼາຍໂມເດລດ້ວຍກະແຈ API ດຽວ ລວມທັງໂມເດລຟຣີ.",
  "settings.gateways.tag.connected": "ເຊື່ອມຕໍ່ແລ້ວ",
  "settings.gateways.note.kilo": "ປະຕູທາງຜ່ານທີ່ເຂົ້າກັນໄດ້ກັບ OpenRouter ພ້ອມໂມເດລຟຣີທີ່ຈັດເສັ້ນທາງອັດຕະໂນມັດ",
  "settings.gateways.note.zoo": "ປະຕູທາງຜ່ານຊຸມຊົນຈາກໂຄງການ Zoo Code",
  "settings.gateways.connect.title": "ເຊື່ອມຕໍ່ {{gateway}}",
  "settings.gateways.connect.description": "ວາງກະແຈ API {{gateway}} ຂອງທ່ານເພື່ອເຊື່ອມຕໍ່ໂມເດລຂອງມັນ.",
