export const dict = {
  ...
  "settings.gateways.title": "ເກດເວ",
  "settings.gateways.description": "ເຊື່ອມຕໍ່ເກດເວ AI ເພື່ອເຂົ້າເຖິງຫຼາຍຕົວແບບຜ່ານກະແຈ API ດຽວ ລວມທັງຕົວແບບຟຣີ.",
  "settings.gateways.tag.connected": "ເຊື່ອມຕໍ່ແລ້ວ",
  "settings.gateways.note.kilo": "ເກດເວທີ່ເຂົ້າກັນໄດ້ກັບ OpenRouter ພ້ອມຕົວແບບຟຣີທີ່ກຳນົດເສັ້ນທາງອັດຕະໂນມັດ",
  "settings.gateways.note.zoo": "ເກດເວຊຸມຊົນຈາກໂຄງການ Zoo Code",
  "settings.gateways.connect.title": "ເຊື່ອມຕໍ່ {{gateway}}",
  "settings.gateways.connect.description": "ວາງກະແຈ API {{gateway}} ຂອງທ່ານເພື່ອເຊື່ອມຕໍ່ຕົວແບບຂອງມັນ.",
