export const dict = {
  ...
  "settings.gateways.description": "ເຊື່ອມຕໍ່ເກດເວ AI ເພື່ອເຂົ້າເຖິງຫຼາຍໂມເດລຜ່ານກະແຈ API ດຽວ ລວມທັງໂມເດລຟຣີ.",
  "settings.gateways.tag.connected": "ເຊື່ອມຕໍ່ແລ້ວ",
  "settings.gateways.note.kilo": "ເກດເວທີ່ເຂົ້າກັນໄດ້ກັບ OpenRouter ພ້ອມໂມເດລຟຣີທີ່ຖືກກຳນົດເສັ້ນທາງອັດຕະໂນມັດ",
